...
#DesignerProperty: Key: ReturnObject, DisplayName: ReturnObject, FieldType: Boolean, DefaultValue: True , Description: 
...
Private mReturnObject As Boolean = True
...
AddAttr("delimiters", mDelimiters)
...
public Sub setDelimiters(varDelimiters As List)
AddAttr("delimiters", varDelimiters)
mDelimiters = varDelimiters
End Sub

public Sub getDelimiters() As List
Return mDelimiters
End Sub
