...
#DesignerProperty: Key: MultiLine, DisplayName: MultiLine, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Timeout, DisplayName: Timeout, FieldType: String, DefaultValue: 5000 , Description: 
#DesignerProperty: Key: Top, DisplayName: Top, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: v-snack-transition , Description: 
...
Private mTimeout As String = "5000"
Private mTop As Boolean = False
Private mTransition As String = "v-snack-transition"
...
mMultiLine = Props.Get("MultiLine")
...
public Sub setMultiLine(varMultiLine As Boolean)
AddAttr("multi-line", varMultiLine)
mMultiLine = varMultiLine
End Sub
