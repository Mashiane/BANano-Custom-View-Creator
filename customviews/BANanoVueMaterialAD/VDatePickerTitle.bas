...
#DesignerProperty: Key: Date, DisplayName: Date, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: SelectingYear, DisplayName: SelectingYear, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Year, DisplayName: Year, FieldType: String, DefaultValue:  , Description: 
...
Private mSelectingYear As Boolean = False
...
AddAttr("ref", mRef)
AddAttr("selecting-year", mSelectingYear)
...
public Sub setDate(varDate As String)
AddAttr("date", varDate)
mDate = varDate
End Sub
...
public Sub setSelectingYear(varSelectingYear As Boolean)
AddAttr("selecting-year", varSelectingYear)
mSelectingYear = varSelectingYear
End Sub

public Sub getSelectingYear() As Boolean
Return mSelectingYear
End Sub
...
public Sub setYear(varYear As String)
AddAttr("year", varYear)
mYear = varYear
End Sub
