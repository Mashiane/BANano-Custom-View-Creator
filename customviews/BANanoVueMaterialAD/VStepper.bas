...
#DesignerProperty: Key: AltLabels, DisplayName: AltLabels, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: NonLinear, DisplayName: NonLinear, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAltLabels As Boolean = False
Private mDark As Boolean = False
Private mKey As String = ""
Private mLight As Boolean = False
Private mNonLinear As Boolean = False
...
mAltLabels = Props.Get("AltLabels")
mDark = Props.Get("Dark")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mNonLinear = Props.Get("NonLinear")
...
AddAttr("alt-labels", mAltLabels)
AddAttr("dark", mDark)
AddAttr("key", mKey)
AddAttr("light", mLight)
AddAttr("non-linear", mNonLinear)
...
public Sub setAltLabels(varAltLabels As Boolean)
AddAttr("alt-labels", varAltLabels)
mAltLabels = varAltLabels
End Sub

public Sub getAltLabels() As Boolean
Return mAltLabels
End Sub
...
public Sub setNonLinear(varNonLinear As Boolean)
AddAttr("non-linear", varNonLinear)
mNonLinear = varNonLinear
End Sub

public Sub getNonLinear() As Boolean
Return mNonLinear
End Sub
