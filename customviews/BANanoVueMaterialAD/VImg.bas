...
#DesignerProperty: Key: AspectRatio, DisplayName: AspectRatio, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Contain, DisplayName: Contain, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Gradient, DisplayName: Gradient, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: LazySrc, DisplayName: LazySrc, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Position, DisplayName: Position, FieldType: String, DefaultValue: center center , Description: 
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: Sizes, DisplayName: Sizes, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: fade-transition , Description: 
...
Private mAspectRatio As String = ""
Private mContain As Boolean = False
Private mDark As Boolean = False
Private mEager As Boolean = False
Private mGradient As String = ""
Private mHeight As String = ""
Private mKey As String = ""
Private mLazySrc As String = ""
...
Private mPosition As String = "center center"
Private mRef As String = ""
Private mSizes As String = ""
Private mSrc As String = ""
Private mSrcset As String = ""
Private mTransition As String = "fade-transition"
...
mAlt = Props.Get("Alt")
mAspectRatio = Props.Get("AspectRatio")
mContain = Props.Get("Contain")
mDark = Props.Get("Dark")
mEager = Props.Get("Eager")
mGradient = Props.Get("Gradient")
mHeight = Props.Get("Height")
mKey = Props.Get("Key")
mLazySrc = Props.Get("LazySrc")
...
mPosition = Props.Get("Position")
mRef = Props.Get("Ref")
mSizes = Props.Get("Sizes")
mSrc = Props.Get("Src")
...
AddAttr("alt", mAlt)
AddAttr("aspect-ratio", mAspectRatio)
AddAttr("contain", mContain)
AddAttr("dark", mDark)
AddAttr("eager", mEager)
AddAttr("gradient", mGradient)
AddAttr("height", mHeight)
AddAttr("key", mKey)
AddAttr("lazy-src", mLazySrc)
...
AddAttr("position", mPosition)
AddAttr("ref", mRef)
AddAttr("sizes", mSizes)
AddAttr("src", mSrc)
...
public Sub setAspectRatio(varAspectRatio As String)
AddAttr("aspect-ratio", varAspectRatio)
mAspectRatio = varAspectRatio
End Sub

public Sub getAspectRatio() As String
Return mAspectRatio
End Sub
...
public Sub setLazySrc(varLazySrc As String)
AddAttr("lazy-src", varLazySrc)
mLazySrc = varLazySrc
End Sub

public Sub getLazySrc() As String
Return mLazySrc
End Sub
