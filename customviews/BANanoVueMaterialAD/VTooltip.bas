...
#DesignerProperty: Key: Fixed, DisplayName: Fixed, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: OpenOnClick, DisplayName: OpenOnClick, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: OpenOnFocus, DisplayName: OpenOnFocus, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: OpenOnHover, DisplayName: OpenOnHover, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: span , Description: 
#DesignerProperty: Key: Top, DisplayName: Top, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue:  , Description: 
...
Private mFixed As Boolean = True
...
Private mOpenOnClick As Boolean = False
Private mOpenOnFocus As Boolean = False
Private mOpenOnHover As Boolean = True
...
Private mTag As String = "span"
Private mTop As Boolean = False
Private mTransition As String = ""
