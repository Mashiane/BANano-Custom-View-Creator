...
#DesignerProperty: Key: Hover, DisplayName: Hover, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Href, DisplayName: Href, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Img, DisplayName: Img, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: LoaderHeight, DisplayName: LoaderHeight, FieldType: String, DefaultValue: 4 , Description: 
...
#DesignerProperty: Key: Raised, DisplayName: Raised, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mLoaderHeight As String = "4"
...
Private mRaised As Boolean = False
