...
#DesignerProperty: Key: DisableItemsPerPage, DisplayName: DisableItemsPerPage, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: DisablePagination, DisplayName: DisablePagination, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: FirstIcon, DisplayName: FirstIcon, FieldType: String, DefaultValue: $first , Description: 
#DesignerProperty: Key: ItemsPerPageAllText, DisplayName: ItemsPerPageAllText, FieldType: String, DefaultValue: $vuetify.dataFooter.itemsPerPageAll , Description: 

#DesignerProperty: Key: ItemsPerPageText, DisplayName: ItemsPerPageText, FieldType: String, DefaultValue: $vuetify.dataFooter.itemsPerPageText , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: LastIcon, DisplayName: LastIcon, FieldType: String, DefaultValue: $last , Description: 
#DesignerProperty: Key: NextIcon, DisplayName: NextIcon, FieldType: String, DefaultValue: $next , Description: 
#DesignerProperty: Key: Options, DisplayName: Options, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: PageText, DisplayName: PageText, FieldType: String, DefaultValue: $vuetify.dataFooter.pageText , Description: 
#DesignerProperty: Key: Pagination, DisplayName: Pagination, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: ShowCurrentPage, DisplayName: ShowCurrentPage, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ShowFirstLastPage, DisplayName: ShowFirstLastPage, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mDisableItemsPerPage As Boolean = False
Private mDisablePagination As Boolean = False
Private mFirstIcon As String = "$first"
Private mItemsPerPageAllText As String = "$vuetify.dataFooter.itemsPerPageAll"
Private mItemsPerPageOptions As List
Private mItemsPerPageText As String = "$vuetify.dataFooter.itemsPerPageText"
Private mKey As String = ""
Private mLastIcon As String = "$last"
Private mNextIcon As String = "$next"
Private mOptions As String = ""
Private mPageText As String = "$vuetify.dataFooter.pageText"
Private mPagination As String = ""
Private mParentId As String = ""
Private mPrevIcon As String = "$prev"
Private mRef As String = ""
Private mShowCurrentPage As Boolean = False
Private mShowFirstLastPage As Boolean = False
...
mDisableItemsPerPage = Props.Get("DisableItemsPerPage")
mDisablePagination = Props.Get("DisablePagination")
mFirstIcon = Props.Get("FirstIcon")
mItemsPerPageAllText = Props.Get("ItemsPerPageAllText")
mItemsPerPageText = Props.Get("ItemsPerPageText")
mKey = Props.Get("Key")
mLastIcon = Props.Get("LastIcon")
mNextIcon = Props.Get("NextIcon")
mOptions = Props.Get("Options")
mPageText = Props.Get("PageText")
mPagination = Props.Get("Pagination")
mParentId = Props.Get("ParentId")
mPrevIcon = Props.Get("PrevIcon")
mRef = Props.Get("Ref")
mShowCurrentPage = Props.Get("ShowCurrentPage")
mShowFirstLastPage = Props.Get("ShowFirstLastPage")
...
AddAttr("disable-items-per-page", mDisableItemsPerPage)
AddAttr("disable-pagination", mDisablePagination)
AddAttr("first-icon", mFirstIcon)
AddAttr("items-per-page-all-text", mItemsPerPageAllText)
AddAttr("items-per-page-options", mItemsPerPageOptions)
AddAttr("items-per-page-text", mItemsPerPageText)
AddAttr("key", mKey)
AddAttr("last-icon", mLastIcon)
AddAttr("next-icon", mNextIcon)
AddAttr("options", mOptions)
AddAttr("page-text", mPageText)
AddAttr("pagination", mPagination)
AddAttr("parent-id", mParentId)
AddAttr("prev-icon", mPrevIcon)
AddAttr("ref", mRef)
AddAttr("show-current-page", mShowCurrentPage)
AddAttr("show-first-last-page", mShowFirstLastPage)
...
public Sub setDisableItemsPerPage(varDisableItemsPerPage As Boolean)
AddAttr("disable-items-per-page", varDisableItemsPerPage)
mDisableItemsPerPage = varDisableItemsPerPage
End Sub

public Sub getDisableItemsPerPage() As Boolean
Return mDisableItemsPerPage
End Sub
...
public Sub setFirstIcon(varFirstIcon As String)
AddAttr("first-icon", varFirstIcon)
mFirstIcon = varFirstIcon
End Sub

public Sub getFirstIcon() As String
Return mFirstIcon
End Sub

public Sub setItemsPerPageAllText(varItemsPerPageAllText As String)
AddAttr("items-per-page-all-text", varItemsPerPageAllText)
mItemsPerPageAllText = varItemsPerPageAllText
End Sub

public Sub getItemsPerPageAllText() As String
Return mItemsPerPageAllText
End Sub

public Sub setItemsPerPageOptions(varItemsPerPageOptions As List)
AddAttr("items-per-page-options", varItemsPerPageOptions)
mItemsPerPageOptions = varItemsPerPageOptions
End Sub

public Sub getItemsPerPageOptions() As List
Return mItemsPerPageOptions
End Sub

public Sub setItemsPerPageText(varItemsPerPageText As String)
AddAttr("items-per-page-text", varItemsPerPageText)
mItemsPerPageText = varItemsPerPageText
End Sub

public Sub getItemsPerPageText() As String
Return mItemsPerPageText
End Sub
...
public Sub setLastIcon(varLastIcon As String)
AddAttr("last-icon", varLastIcon)
mLastIcon = varLastIcon
End Sub

public Sub getLastIcon() As String
Return mLastIcon
End Sub
...
public Sub setPageText(varPageText As String)
AddAttr("page-text", varPageText)
mPageText = varPageText
End Sub

public Sub getPageText() As String
Return mPageText
End Sub

public Sub setPagination(varPagination As String)
AddAttr("pagination", varPagination)
mPagination = varPagination
End Sub
...
public Sub setShowCurrentPage(varShowCurrentPage As Boolean)
AddAttr("show-current-page", varShowCurrentPage)
mShowCurrentPage = varShowCurrentPage
End Sub

public Sub getShowCurrentPage() As Boolean
Return mShowCurrentPage
End Sub

public Sub setShowFirstLastPage(varShowFirstLastPage As Boolean)
AddAttr("show-first-last-page", varShowFirstLastPage)
mShowFirstLastPage = varShowFirstLastPage
End Sub

public Sub getShowFirstLastPage() As Boolean
Return mShowFirstLastPage
End Sub
