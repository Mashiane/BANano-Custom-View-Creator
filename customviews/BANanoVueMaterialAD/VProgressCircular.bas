...
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, DefaultValue: 32 , Description: 
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 4 , Description: 
