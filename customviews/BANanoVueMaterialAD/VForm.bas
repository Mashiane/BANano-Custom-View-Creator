...
#DesignerProperty: Key: LazyValidation, DisplayName: LazyValidation, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mLazyValidation As Boolean = False
...
mKey = Props.Get("Key")
mLazyValidation = Props.Get("LazyValidation")
...
AddAttr("key", mKey)
AddAttr("lazy-validation", mLazyValidation)
...
public Sub setLazyValidation(varLazyValidation As Boolean)
AddAttr("lazy-validation", varLazyValidation)
mLazyValidation = varLazyValidation
End Sub

public Sub getLazyValidation() As Boolean
Return mLazyValidation
End Sub
