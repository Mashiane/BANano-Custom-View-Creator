...
#DesignerProperty: Key: IconColor, DisplayName: IconColor, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Sticky, DisplayName: Sticky, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mSticky As Boolean = False
...
public Sub setIconColor(varIconColor As String)
AddAttr("icon-color", varIconColor)
mIconColor = varIconColor
End Sub

public Sub getIconColor() As String
Return mIconColor
End Sub
