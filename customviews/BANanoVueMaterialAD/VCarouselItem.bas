...
#DesignerProperty: Key: ReverseTransition, DisplayName: ReverseTransition, FieldType: String, DefaultValue:  , Description: 
...
Private mReverseTransition As String = ""
...
mReverseTransition = Props.Get("ReverseTransition")
...
AddAttr("reverse-transition", mReverseTransition)
...
public Sub setReverseTransition(varReverseTransition As String)
AddAttr("reverse-transition", varReverseTransition)
mReverseTransition = varReverseTransition
End Sub

public Sub getReverseTransition() As String
Return mReverseTransition
End Sub
