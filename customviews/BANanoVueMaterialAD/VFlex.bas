...
#DesignerProperty: Key: AlignSelfBaseline, DisplayName: AlignSelfBaseline, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignSelfCenter, DisplayName: AlignSelfCenter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignSelfEnd, DisplayName: AlignSelfEnd, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignSelfStart, DisplayName: AlignSelfStart, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAlignSelfBaseline As Boolean = False
Private mAlignSelfCenter As Boolean = False
Private mAlignSelfEnd As Boolean = False
Private mAlignSelfStart As Boolean = False
Private mGrow As Boolean = False
Private mId As String = ""
Private mKey As String = ""
Private mParentId As String = ""
Private mRef As String = ""
Private mShrink As Boolean = False
...
mAlignSelfBaseline = Props.Get("AlignSelfBaseline")
mAlignSelfCenter = Props.Get("AlignSelfCenter")
mAlignSelfEnd = Props.Get("AlignSelfEnd")
mAlignSelfStart = Props.Get("AlignSelfStart")
mGrow = Props.Get("Grow")
mId = Props.Get("Id")
mKey = Props.Get("Key")
mParentId = Props.Get("ParentId")
mRef = Props.Get("Ref")
mShrink = Props.Get("Shrink")
mTag = Props.Get("Tag")
...
AddAttr("align-self-baseline", mAlignSelfBaseline)
AddAttr("align-self-center", mAlignSelfCenter)
AddAttr("align-self-end", mAlignSelfEnd)
AddAttr("align-self-start", mAlignSelfStart)
AddAttr("grow", mGrow)
AddAttr("id", mId)
AddAttr("key", mKey)
AddAttr("parent-id", mParentId)
AddAttr("ref", mRef)
AddAttr("shrink", mShrink)
AddAttr("tag", mTag)
...
public Sub setAlignSelfBaseline(varAlignSelfBaseline As Boolean)
AddAttr("align-self-baseline", varAlignSelfBaseline)
mAlignSelfBaseline = varAlignSelfBaseline
End Sub

public Sub getAlignSelfBaseline() As Boolean
Return mAlignSelfBaseline
End Sub

public Sub setAlignSelfCenter(varAlignSelfCenter As Boolean)
AddAttr("align-self-center", varAlignSelfCenter)
mAlignSelfCenter = varAlignSelfCenter
End Sub

public Sub getAlignSelfCenter() As Boolean
Return mAlignSelfCenter
End Sub

public Sub setAlignSelfEnd(varAlignSelfEnd As Boolean)
AddAttr("align-self-end", varAlignSelfEnd)
mAlignSelfEnd = varAlignSelfEnd
End Sub

public Sub getAlignSelfEnd() As Boolean
Return mAlignSelfEnd
End Sub

public Sub setAlignSelfStart(varAlignSelfStart As Boolean)
AddAttr("align-self-start", varAlignSelfStart)
mAlignSelfStart = varAlignSelfStart
End Sub

public Sub getAlignSelfStart() As Boolean
Return mAlignSelfStart
End Sub
