...
#DesignerProperty: Key: Inset, DisplayName: Inset, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Padless, DisplayName: Padless, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: footer , Description: 
...
Private mInset As Boolean = False
