...
#DesignerProperty: Key: EveryItem, DisplayName: EveryItem, FieldType: Boolean, DefaultValue: False , Description: 

#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Mobile, DisplayName: Mobile, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: SomeItems, DisplayName: SomeItems, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: SortIcon, DisplayName: SortIcon, FieldType: String, DefaultValue: $sort , Description: 
...
Private mEveryItem As Boolean = False
Private mHeaders As List
Private mKey As String = ""
Private mMobile As Boolean = False
Private mOptions As String = ""
Private mParentId As String = ""
Private mRef As String = ""
Private mShowGroupBy As Boolean = False
Private mSingleSelect As Boolean = False
Private mSomeItems As Boolean = False
Private mSortIcon As String = "$sort"
...
mEveryItem = Props.Get("EveryItem")
mKey = Props.Get("Key")
mMobile = Props.Get("Mobile")
mOptions = Props.Get("Options")
mParentId = Props.Get("ParentId")
mRef = Props.Get("Ref")
mShowGroupBy = Props.Get("ShowGroupBy")
mSingleSelect = Props.Get("SingleSelect")
mSomeItems = Props.Get("SomeItems")
mSortIcon = Props.Get("SortIcon")
...
AddAttr("every-item", mEveryItem)
AddAttr("headers", mHeaders)
AddAttr("key", mKey)
AddAttr("mobile", mMobile)
AddAttr("options", mOptions)
AddAttr("parent-id", mParentId)
AddAttr("ref", mRef)
AddAttr("show-group-by", mShowGroupBy)
AddAttr("single-select", mSingleSelect)
AddAttr("some-items", mSomeItems)
AddAttr("sort-icon", mSortIcon)
...
public Sub setEveryItem(varEveryItem As Boolean)
AddAttr("every-item", varEveryItem)
mEveryItem = varEveryItem
End Sub

public Sub getEveryItem() As Boolean
Return mEveryItem
End Sub

public Sub setHeaders(varHeaders As List)
AddAttr("headers", varHeaders)
mHeaders = varHeaders
End Sub

public Sub getHeaders() As List
Return mHeaders
End Sub
...
public Sub setMobile(varMobile As Boolean)
AddAttr("mobile", varMobile)
mMobile = varMobile
End Sub

public Sub getMobile() As Boolean
Return mMobile
End Sub
...
public Sub setShowGroupBy(varShowGroupBy As Boolean)
AddAttr("show-group-by", varShowGroupBy)
mShowGroupBy = varShowGroupBy
End Sub

public Sub getShowGroupBy() As Boolean
Return mShowGroupBy
End Sub
...
public Sub setSomeItems(varSomeItems As Boolean)
AddAttr("some-items", varSomeItems)
mSomeItems = varSomeItems
End Sub

public Sub getSomeItems() As Boolean
Return mSomeItems
End Sub

public Sub setSortIcon(varSortIcon As String)
AddAttr("sort-icon", varSortIcon)
mSortIcon = varSortIcon
End Sub

public Sub getSortIcon() As String
Return mSortIcon
End Sub
