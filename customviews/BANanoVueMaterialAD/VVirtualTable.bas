...
#DesignerProperty: Key: ChunkSize, DisplayName: ChunkSize, FieldType: String, DefaultValue: 25 , Description: 
...
#DesignerProperty: Key: FixedHeader, DisplayName: FixedHeader, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HeaderHeight, DisplayName: HeaderHeight, FieldType: String, DefaultValue: 48 , Description: 
...
#DesignerProperty: Key: RowHeight, DisplayName: RowHeight, FieldType: String, DefaultValue: 48 , Description: 
...
Private mChunkSize As String = "25"
Private mDark As Boolean = False
Private mDense As Boolean = False
Private mFixedHeader As Boolean = False
Private mHeaderHeight As String = "48"
...
Private mRowHeight As String = "48"
...
mChunkSize = Props.Get("ChunkSize")
mDark = Props.Get("Dark")
mDense = Props.Get("Dense")
mFixedHeader = Props.Get("FixedHeader")
mHeaderHeight = Props.Get("HeaderHeight")
...
AddAttr("chunk-size", mChunkSize)
AddAttr("dark", mDark)
AddAttr("dense", mDense)
AddAttr("fixed-header", mFixedHeader)
AddAttr("header-height", mHeaderHeight)
...
public Sub setChunkSize(varChunkSize As String)
AddAttr("chunk-size", varChunkSize)
mChunkSize = varChunkSize
End Sub

public Sub getChunkSize() As String
Return mChunkSize
End Sub
...
public Sub setFixedHeader(varFixedHeader As Boolean)
AddAttr("fixed-header", varFixedHeader)
mFixedHeader = varFixedHeader
End Sub

public Sub getFixedHeader() As Boolean
Return mFixedHeader
End Sub

public Sub setHeaderHeight(varHeaderHeight As String)
AddAttr("header-height", varHeaderHeight)
mHeaderHeight = varHeaderHeight
End Sub

public Sub getHeaderHeight() As String
