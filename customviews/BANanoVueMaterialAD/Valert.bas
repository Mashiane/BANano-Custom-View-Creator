...
#DesignerProperty: Key: CloseIcon, DisplayName: CloseIcon, FieldType: String, DefaultValue: $cancel , Description: 
#DesignerProperty: Key: CloseLabel, DisplayName: CloseLabel, FieldType: String, DefaultValue: $vuetify.close , Description: 
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ColoredBorder, DisplayName: ColoredBorder, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Dismissible, DisplayName: Dismissible, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Icon, DisplayName: Icon, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue:  , Description: 
...
Private mCloseIcon As String = "$cancel"
Private mCloseLabel As String = "$vuetify.close"
Private mColor As String = ""
Private mColoredBorder As Boolean = False
Private mDark As Boolean = False
Private mDense As Boolean = False
Private mDismissible As Boolean = False
...
mCloseLabel = Props.Get("CloseLabel")
mColor = Props.Get("Color")
mColoredBorder = Props.Get("ColoredBorder")
mDark = Props.Get("Dark")
mDense = Props.Get("Dense")
mDismissible = Props.Get("Dismissible")
...
AddAttr("border", mBorder)
AddAttr("close-icon", mCloseIcon)
AddAttr("close-label", mCloseLabel)
AddAttr("color", mColor)
AddAttr("colored-border", mColoredBorder)
AddAttr("dark", mDark)
AddAttr("dense", mDense)
AddAttr("dismissible", mDismissible)
...
public Sub setCloseLabel(varCloseLabel As String)
AddAttr("close-label", varCloseLabel)
mCloseLabel = varCloseLabel
End Sub

public Sub getCloseLabel() As String
Return mCloseLabel
End Sub
...
public Sub setColoredBorder(varColoredBorder As Boolean)
AddAttr("colored-border", varColoredBorder)
mColoredBorder = varColoredBorder
End Sub

public Sub getColoredBorder() As Boolean
Return mColoredBorder
End Sub
