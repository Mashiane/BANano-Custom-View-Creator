...
#DesignerProperty: Key: AlignContent, DisplayName: AlignContent, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignContentLg, DisplayName: AlignContentLg, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignContentMd, DisplayName: AlignContentMd, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignContentSm, DisplayName: AlignContentSm, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignContentXl, DisplayName: AlignContentXl, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignLg, DisplayName: AlignLg, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignMd, DisplayName: AlignMd, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignSm, DisplayName: AlignSm, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: AlignXl, DisplayName: AlignXl, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Justify, DisplayName: Justify, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: JustifyLg, DisplayName: JustifyLg, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: JustifyMd, DisplayName: JustifyMd, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: JustifySm, DisplayName: JustifySm, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: JustifyXl, DisplayName: JustifyXl, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: NoGutters, DisplayName: NoGutters, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAlignContent As String = ""
Private mAlignContentLg As String = ""
Private mAlignContentMd As String = ""
Private mAlignContentSm As String = ""
Private mAlignContentXl As String = ""
Private mAlignLg As String = ""
Private mAlignMd As String = ""
Private mAlignSm As String = ""
Private mAlignXl As String = ""
Private mDense As Boolean = False
Private mJustify As String = ""
Private mJustifyLg As String = ""
Private mJustifyMd As String = ""
Private mJustifySm As String = ""
Private mJustifyXl As String = ""
Private mKey As String = ""
Private mNoGutters As Boolean = False
...
mAlignContent = Props.Get("AlignContent")
mAlignContentLg = Props.Get("AlignContentLg")
mAlignContentMd = Props.Get("AlignContentMd")
mAlignContentSm = Props.Get("AlignContentSm")
mAlignContentXl = Props.Get("AlignContentXl")
mAlignLg = Props.Get("AlignLg")
mAlignMd = Props.Get("AlignMd")
mAlignSm = Props.Get("AlignSm")
mAlignXl = Props.Get("AlignXl")
mDense = Props.Get("Dense")
mJustify = Props.Get("Justify")
mJustifyLg = Props.Get("JustifyLg")
mJustifyMd = Props.Get("JustifyMd")
mJustifySm = Props.Get("JustifySm")
mJustifyXl = Props.Get("JustifyXl")
mKey = Props.Get("Key")
mNoGutters = Props.Get("NoGutters")
...
AddAttr("align", mAlign)
AddAttr("align-content", mAlignContent)
AddAttr("align-content-lg", mAlignContentLg)
AddAttr("align-content-md", mAlignContentMd)
AddAttr("align-content-sm", mAlignContentSm)
AddAttr("align-content-xl", mAlignContentXl)
AddAttr("align-lg", mAlignLg)
AddAttr("align-md", mAlignMd)
AddAttr("align-sm", mAlignSm)
AddAttr("align-xl", mAlignXl)
AddAttr("dense", mDense)
AddAttr("justify", mJustify)
AddAttr("justify-lg", mJustifyLg)
AddAttr("justify-md", mJustifyMd)
AddAttr("justify-sm", mJustifySm)
AddAttr("justify-xl", mJustifyXl)
AddAttr("key", mKey)
AddAttr("no-gutters", mNoGutters)
...
public Sub setAlignContent(varAlignContent As String)
AddAttr("align-content", varAlignContent)
mAlignContent = varAlignContent
End Sub
...
public Sub setAlignContentLg(varAlignContentLg As String)
AddAttr("align-content-lg", varAlignContentLg)
mAlignContentLg = varAlignContentLg
End Sub

public Sub getAlignContentLg() As String
Return mAlignContentLg
End Sub

public Sub setAlignContentMd(varAlignContentMd As String)
AddAttr("align-content-md", varAlignContentMd)
mAlignContentMd = varAlignContentMd
End Sub

public Sub getAlignContentMd() As String
Return mAlignContentMd
End Sub

public Sub setAlignContentSm(varAlignContentSm As String)
AddAttr("align-content-sm", varAlignContentSm)
mAlignContentSm = varAlignContentSm
End Sub

public Sub getAlignContentSm() As String
Return mAlignContentSm
End Sub

public Sub setAlignContentXl(varAlignContentXl As String)
AddAttr("align-content-xl", varAlignContentXl)
mAlignContentXl = varAlignContentXl
End Sub

public Sub getAlignContentXl() As String
Return mAlignContentXl
End Sub

public Sub setAlignLg(varAlignLg As String)
AddAttr("align-lg", varAlignLg)
mAlignLg = varAlignLg
End Sub

public Sub getAlignLg() As String
Return mAlignLg
End Sub

public Sub setAlignMd(varAlignMd As String)
AddAttr("align-md", varAlignMd)
mAlignMd = varAlignMd
End Sub

public Sub getAlignMd() As String
Return mAlignMd
End Sub

public Sub setAlignSm(varAlignSm As String)
AddAttr("align-sm", varAlignSm)
mAlignSm = varAlignSm
End Sub

public Sub getAlignSm() As String
Return mAlignSm
End Sub

public Sub setAlignXl(varAlignXl As String)
AddAttr("align-xl", varAlignXl)
mAlignXl = varAlignXl
End Sub

public Sub getAlignXl() As String
Return mAlignXl
End Sub
...
public Sub setJustifyLg(varJustifyLg As String)
AddAttr("justify-lg", varJustifyLg)
mJustifyLg = varJustifyLg
End Sub

public Sub getJustifyLg() As String
Return mJustifyLg
End Sub

public Sub setJustifyMd(varJustifyMd As String)
AddAttr("justify-md", varJustifyMd)
mJustifyMd = varJustifyMd
End Sub

public Sub getJustifyMd() As String
Return mJustifyMd
End Sub

public Sub setJustifySm(varJustifySm As String)
AddAttr("justify-sm", varJustifySm)
mJustifySm = varJustifySm
End Sub

public Sub getJustifySm() As String
Return mJustifySm
End Sub

public Sub setJustifyXl(varJustifyXl As String)
AddAttr("justify-xl", varJustifyXl)
mJustifyXl = varJustifyXl
End Sub

public Sub getJustifyXl() As String
Return mJustifyXl
End Sub
...
public Sub setNoGutters(varNoGutters As Boolean)
AddAttr("no-gutters", varNoGutters)
mNoGutters = varNoGutters
End Sub
