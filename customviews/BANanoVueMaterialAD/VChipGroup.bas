...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-slide-item--active , Description: 
...
Private mActiveClass As String = "v-slide-item--active"
