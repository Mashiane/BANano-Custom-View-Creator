...
#DesignerProperty: Key: AllowOverflow, DisplayName: AllowOverflow, FieldType: Boolean, DefaultValue: True , Description: 
#DesignerProperty: Key: AppendIcon, DisplayName: AppendIcon, FieldType: String, DefaultValue: $dropdown , Description: 
#DesignerProperty: Key: AppendOuterIcon, DisplayName: AppendOuterIcon, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Attach, DisplayName: Attach, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: AutoSelectFirst, DisplayName: AutoSelectFirst, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: CacheItems, DisplayName: CacheItems, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Chips, DisplayName: Chips, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ClearIcon, DisplayName: ClearIcon, FieldType: String, DefaultValue: $clear , Description: 
...
#DesignerProperty: Key: CounterValue, DisplayName: CounterValue, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Dark, DisplayName: Dark, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: DeletableChips, DisplayName: DeletableChips, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Dense, DisplayName: Dense, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: DisableLookup, DisplayName: DisableLookup, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Disabled, DisplayName: Disabled, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Eager, DisplayName: Eager, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Editable, DisplayName: Editable, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Error, DisplayName: Error, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ErrorCount, DisplayName: ErrorCount, FieldType: String, DefaultValue: 1 , Description: 
#DesignerProperty: Key: ErrorMessages, DisplayName: ErrorMessages, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Filled, DisplayName: Filled, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Filter, DisplayName: Filter, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: HideDetails, DisplayName: HideDetails, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: HideNoData, DisplayName: HideNoData, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideSelected, DisplayName: HideSelected, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Hint, DisplayName: Hint, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Id, DisplayName: Id, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ItemColor, DisplayName: ItemColor, FieldType: String, DefaultValue: primary , Description: 
#DesignerProperty: Key: ItemDisabled, DisplayName: ItemDisabled, FieldType: String, DefaultValue: disabled , Description: 
#DesignerProperty: Key: ItemText, DisplayName: ItemText, FieldType: String, DefaultValue: text , Description: 
#DesignerProperty: Key: ItemValue, DisplayName: ItemValue, FieldType: String, DefaultValue: value , Description: 
...
#DesignerProperty: Key: LoaderHeight, DisplayName: LoaderHeight, FieldType: String, DefaultValue: 2 , Description: 
#DesignerProperty: Key: Loading, DisplayName: Loading, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: MenuProps, DisplayName: MenuProps, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Messages, DisplayName: Messages, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Multiple, DisplayName: Multiple, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: NoDataText, DisplayName: NoDataText, FieldType: String, DefaultValue: $vuetify.noDataText , Description: 
#DesignerProperty: Key: NoFilter, DisplayName: NoFilter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: OpenOnClear, DisplayName: OpenOnClear, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Prefix, DisplayName: Prefix, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: SearchInput, DisplayName: SearchInput, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Segmented, DisplayName: Segmented, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: SmallChips, DisplayName: SmallChips, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Solo, DisplayName: Solo, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: SoloInverted, DisplayName: SoloInverted, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Success, DisplayName: Success, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: SuccessMessages, DisplayName: SuccessMessages, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Suffix, DisplayName: Suffix, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue: text , Description: 
...
#DesignerProperty: Key: ValidateOnBlur, DisplayName: ValidateOnBlur, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ValueComparator, DisplayName: ValueComparator, FieldType: String, DefaultValue:  , Description: 
...
Private mAllowOverflow As Boolean = True
Private mAppendIcon As String = "$dropdown"
Private mAppendOuterIcon As String = ""
Private mAttach As String = "false"
Private mAutoSelectFirst As Boolean = False
Private mAutofocus As Boolean = False
Private mBackgroundColor As String = ""
Private mCacheItems As Boolean = False
Private mChips As Boolean = False
Private mClearIcon As String = "$clear"
Private mClearable As Boolean = False
Private mColor As String = ""
Private mCounter As String = ""
Private mCounterValue As String = ""
Private mDark As Boolean = False
Private mDeletableChips As Boolean = False
Private mDense As Boolean = False
Private mDisableLookup As Boolean = False
Private mDisabled As Boolean = False
Private mEager As Boolean = False
Private mEditable As Boolean = False
Private mError As Boolean = False
Private mErrorCount As String = "1"
Private mErrorMessages As String = ""
Private mFilled As Boolean = False
Private mFilter As String = ""
Private mFlat As Boolean = False
Private mFullWidth As Boolean = False
Private mHeight As String = ""
Private mHideDetails As String = ""
Private mHideNoData As Boolean = False
Private mHideSelected As Boolean = False
Private mHint As String = ""
Private mId As String = ""
Private mItemColor As String = "primary"
Private mItemDisabled As String = "disabled"
Private mItemText As String = "text"
Private mItemValue As String = "value"
Private mItems As List
Private mKey As String = ""
Private mLabel As String = ""
Private mLight As Boolean = False
Private mLoaderHeight As String = "2"
Private mLoading As String = "false"
Private mMenuProps As String = ""
Private mMessages As String = ""
Private mMultiple As Boolean = False
Private mNoDataText As String = "$vuetify.noDataText"
Private mNoFilter As Boolean = False
Private mOpenOnClear As Boolean = False
Private mOutlined As Boolean = False
Private mParentId As String = ""
Private mPersistentHint As Boolean = False
Private mPlaceholder As String = ""
Private mPrefix As String = ""
Private mPrependIcon As String = ""
Private mPrependInnerIcon As String = ""
Private mReadonly As Boolean = False
Private mRef As String = ""
Private mReturnObject As Boolean = False
Private mReverse As Boolean = False
Private mRounded As Boolean = False
Private mRules As List
Private mSearchInput As String = ""
Private mSegmented As Boolean = False
Private mShaped As Boolean = False
Private mSingleLine As Boolean = False
Private mSmallChips As Boolean = False
Private mSolo As Boolean = False
Private mSoloInverted As Boolean = False
Private mSuccess As Boolean = False
Private mSuccessMessages As String = ""
...
Private mValidateOnBlur As Boolean = False
Private mValue As String = ""
Private mValueComparator As String = ""
...
mAllowOverflow = Props.Get("AllowOverflow")
mAppendIcon = Props.Get("AppendIcon")
mAppendOuterIcon = Props.Get("AppendOuterIcon")
mAttach = Props.Get("Attach")
mAutoSelectFirst = Props.Get("AutoSelectFirst")
mAutofocus = Props.Get("Autofocus")
mBackgroundColor = Props.Get("BackgroundColor")
mCacheItems = Props.Get("CacheItems")
mChips = Props.Get("Chips")
mClearIcon = Props.Get("ClearIcon")
mClearable = Props.Get("Clearable")
mColor = Props.Get("Color")
mCounter = Props.Get("Counter")
mCounterValue = Props.Get("CounterValue")
mDark = Props.Get("Dark")
mDeletableChips = Props.Get("DeletableChips")
mDense = Props.Get("Dense")
mDisableLookup = Props.Get("DisableLookup")
mDisabled = Props.Get("Disabled")
mEager = Props.Get("Eager")
mEditable = Props.Get("Editable")
mError = Props.Get("Error")
mErrorCount = Props.Get("ErrorCount")
mErrorMessages = Props.Get("ErrorMessages")
mFilled = Props.Get("Filled")
mFilter = Props.Get("Filter")
mFlat = Props.Get("Flat")
mFullWidth = Props.Get("FullWidth")
mHeight = Props.Get("Height")
mHideDetails = Props.Get("HideDetails")
mHideNoData = Props.Get("HideNoData")
mHideSelected = Props.Get("HideSelected")
mHint = Props.Get("Hint")
mId = Props.Get("Id")
mItemColor = Props.Get("ItemColor")
mItemDisabled = Props.Get("ItemDisabled")
mItemText = Props.Get("ItemText")
mItemValue = Props.Get("ItemValue")
mKey = Props.Get("Key")
mLabel = Props.Get("Label")
mLight = Props.Get("Light")
mLoaderHeight = Props.Get("LoaderHeight")
mLoading = Props.Get("Loading")
mMenuProps = Props.Get("MenuProps")
mMessages = Props.Get("Messages")
mMultiple = Props.Get("Multiple")
mNoDataText = Props.Get("NoDataText")
mNoFilter = Props.Get("NoFilter")
mOpenOnClear = Props.Get("OpenOnClear")
mOutlined = Props.Get("Outlined")
mParentId = Props.Get("ParentId")
mPersistentHint = Props.Get("PersistentHint")
mPlaceholder = Props.Get("Placeholder")
mPrefix = Props.Get("Prefix")
mPrependIcon = Props.Get("PrependIcon")
mPrependInnerIcon = Props.Get("PrependInnerIcon")
mReadonly = Props.Get("Readonly")
mRef = Props.Get("Ref")
mReturnObject = Props.Get("ReturnObject")
mReverse = Props.Get("Reverse")
mRounded = Props.Get("Rounded")
mSearchInput = Props.Get("SearchInput")
mSegmented = Props.Get("Segmented")
mShaped = Props.Get("Shaped")
mSingleLine = Props.Get("SingleLine")
mSmallChips = Props.Get("SmallChips")
mSolo = Props.Get("Solo")
mSoloInverted = Props.Get("SoloInverted")
mSuccess = Props.Get("Success")
mSuccessMessages = Props.Get("SuccessMessages")
...
mValidateOnBlur = Props.Get("ValidateOnBlur")
mValue = Props.Get("Value")
mValueComparator = Props.Get("ValueComparator")
...
AddAttr("allow-overflow", mAllowOverflow)
AddAttr("append-icon", mAppendIcon)
AddAttr("append-outer-icon", mAppendOuterIcon)
AddAttr("attach", mAttach)
AddAttr("auto-select-first", mAutoSelectFirst)
AddAttr("autofocus", mAutofocus)
AddAttr("background-color", mBackgroundColor)
AddAttr("cache-items", mCacheItems)
AddAttr("chips", mChips)
AddAttr("clear-icon", mClearIcon)
AddAttr("clearable", mClearable)
AddAttr("color", mColor)
AddAttr("counter", mCounter)
AddAttr("counter-value", mCounterValue)
AddAttr("dark", mDark)
AddAttr("deletable-chips", mDeletableChips)
AddAttr("dense", mDense)
AddAttr("disable-lookup", mDisableLookup)
AddAttr("disabled", mDisabled)
AddAttr("eager", mEager)
AddAttr("editable", mEditable)
AddAttr("error", mError)
AddAttr("error-count", mErrorCount)
AddAttr("error-messages", mErrorMessages)
AddAttr("filled", mFilled)
AddAttr("filter", mFilter)
AddAttr("flat", mFlat)
AddAttr("full-width", mFullWidth)
AddAttr("height", mHeight)
AddAttr("hide-details", mHideDetails)
AddAttr("hide-no-data", mHideNoData)
AddAttr("hide-selected", mHideSelected)
AddAttr("hint", mHint)
AddAttr("id", mId)
AddAttr("item-color", mItemColor)
AddAttr("item-disabled", mItemDisabled)
AddAttr("item-text", mItemText)
AddAttr("item-value", mItemValue)
AddAttr("items", mItems)
AddAttr("key", mKey)
AddAttr("label", mLabel)
AddAttr("light", mLight)
AddAttr("loader-height", mLoaderHeight)
AddAttr("loading", mLoading)
AddAttr("menu-props", mMenuProps)
AddAttr("messages", mMessages)
AddAttr("multiple", mMultiple)
AddAttr("no-data-text", mNoDataText)
AddAttr("no-filter", mNoFilter)
AddAttr("open-on-clear", mOpenOnClear)
AddAttr("outlined", mOutlined)
AddAttr("parent-id", mParentId)
AddAttr("persistent-hint", mPersistentHint)
AddAttr("placeholder", mPlaceholder)
AddAttr("prefix", mPrefix)
AddAttr("prepend-icon", mPrependIcon)
AddAttr("prepend-inner-icon", mPrependInnerIcon)
AddAttr("readonly", mReadonly)
AddAttr("ref", mRef)
AddAttr("return-object", mReturnObject)
AddAttr("reverse", mReverse)
AddAttr("rounded", mRounded)
AddAttr("rules", mRules)
AddAttr("search-input", mSearchInput)
AddAttr("segmented", mSegmented)
AddAttr("shaped", mShaped)
AddAttr("single-line", mSingleLine)
AddAttr("small-chips", mSmallChips)
AddAttr("solo", mSolo)
AddAttr("solo-inverted", mSoloInverted)
AddAttr("success", mSuccess)
AddAttr("success-messages", mSuccessMessages)
AddAttr("suffix", mSuffix)
AddAttr("type", mType)
...
AddAttr("validate-on-blur", mValidateOnBlur)
AddAttr("value", mValue)
AddAttr("value-comparator", mValueComparator)
...
public Sub setAllowOverflow(varAllowOverflow As Boolean)
AddAttr("allow-overflow", varAllowOverflow)
mAllowOverflow = varAllowOverflow
End Sub

public Sub getAllowOverflow() As Boolean
Return mAllowOverflow
End Sub

public Sub setAppendIcon(varAppendIcon As String)
AddAttr("append-icon", varAppendIcon)
mAppendIcon = varAppendIcon
End Sub
...
public Sub setAppendOuterIcon(varAppendOuterIcon As String)
AddAttr("append-outer-icon", varAppendOuterIcon)
mAppendOuterIcon = varAppendOuterIcon
End Sub

public Sub getAppendOuterIcon() As String
Return mAppendOuterIcon
End Sub
...
public Sub setAutoSelectFirst(varAutoSelectFirst As Boolean)
AddAttr("auto-select-first", varAutoSelectFirst)
mAutoSelectFirst = varAutoSelectFirst
End Sub

public Sub getAutoSelectFirst() As Boolean
Return mAutoSelectFirst
End Sub

public Sub setAutofocus(varAutofocus As Boolean)
AddAttr("autofocus", varAutofocus)
mAutofocus = varAutofocus
End Sub
...
public Sub setCacheItems(varCacheItems As Boolean)
AddAttr("cache-items", varCacheItems)
mCacheItems = varCacheItems
End Sub

public Sub getCacheItems() As Boolean
Return mCacheItems
End Sub
...
mClearIcon = varClearIcon
End Sub

public Sub getClearIcon() As String
Return mClearIcon
End Sub

public Sub setClearable(varClearable As Boolean)
AddAttr("clearable", varClearable)
mClearable = varClearable
End Sub
...
public Sub setCounterValue(varCounterValue As String)
AddAttr("counter-value", varCounterValue)
mCounterValue = varCounterValue
End Sub

public Sub getCounterValue() As String
...
public Sub setDeletableChips(varDeletableChips As Boolean)
AddAttr("deletable-chips", varDeletableChips)
mDeletableChips = varDeletableChips
End Sub

public Sub getDeletableChips() As Boolean
Return mDeletableChips
End Sub
...
public Sub setDisableLookup(varDisableLookup As Boolean)
AddAttr("disable-lookup", varDisableLookup)
mDisableLookup = varDisableLookup
End Sub

public Sub getDisableLookup() As Boolean
Return mDisableLookup
End Sub
...
public Sub setErrorCount(varErrorCount As String)
AddAttr("error-count", varErrorCount)
mErrorCount = varErrorCount
End Sub

public Sub getErrorCount() As String
Return mErrorCount
End Sub

public Sub setErrorMessages(varErrorMessages As String)
AddAttr("error-messages", varErrorMessages)
mErrorMessages = varErrorMessages
End Sub

public Sub getErrorMessages() As String
...
public Sub setHideDetails(varHideDetails As String)
AddAttr("hide-details", varHideDetails)
mHideDetails = varHideDetails
End Sub

public Sub getHideDetails() As String
Return mHideDetails
End Sub

public Sub setHideNoData(varHideNoData As Boolean)
AddAttr("hide-no-data", varHideNoData)
mHideNoData = varHideNoData
End Sub

public Sub getHideNoData() As Boolean
Return mHideNoData
End Sub

public Sub setHideSelected(varHideSelected As Boolean)
AddAttr("hide-selected", varHideSelected)
mHideSelected = varHideSelected
End Sub

public Sub getHideSelected() As Boolean
Return mHideSelected
End Sub
...
public Sub setItemColor(varItemColor As String)
AddAttr("item-color", varItemColor)
mItemColor = varItemColor
End Sub

public Sub getItemColor() As String
Return mItemColor
End Sub

public Sub setItemDisabled(varItemDisabled As String)
AddAttr("item-disabled", varItemDisabled)
mItemDisabled = varItemDisabled
End Sub

public Sub getItemDisabled() As String
Return mItemDisabled
End Sub

public Sub setItemText(varItemText As String)
AddAttr("item-text", varItemText)
mItemText = varItemText
End Sub

public Sub getItemText() As String
Return mItemText
End Sub

public Sub setItemValue(varItemValue As String)
AddAttr("item-value", varItemValue)
mItemValue = varItemValue
End Sub

public Sub getItemValue() As String
Return mItemValue
End Sub

public Sub setItems(varItems As List)
...
public Sub setLoaderHeight(varLoaderHeight As String)
AddAttr("loader-height", varLoaderHeight)
mLoaderHeight = varLoaderHeight
End Sub

public Sub getLoaderHeight() As String
Return mLoaderHeight
End Sub
...
public Sub setMenuProps(varMenuProps As String)
AddAttr("menu-props", varMenuProps)
mMenuProps = varMenuProps
End Sub

public Sub getMenuProps() As String
Return mMenuProps
End Sub

public Sub setMessages(varMessages As String)
AddAttr("messages", varMessages)
mMessages = varMessages
End Sub
...
public Sub setNoDataText(varNoDataText As String)
AddAttr("no-data-text", varNoDataText)
mNoDataText = varNoDataText
End Sub

public Sub getNoDataText() As String
Return mNoDataText
End Sub

public Sub setNoFilter(varNoFilter As Boolean)
AddAttr("no-filter", varNoFilter)
mNoFilter = varNoFilter
End Sub

public Sub getNoFilter() As Boolean
Return mNoFilter
End Sub

public Sub setOpenOnClear(varOpenOnClear As Boolean)
AddAttr("open-on-clear", varOpenOnClear)
mOpenOnClear = varOpenOnClear
End Sub

public Sub getOpenOnClear() As Boolean
Return mOpenOnClear
End Sub

public Sub setOutlined(varOutlined As Boolean)
AddAttr("outlined", varOutlined)
mOutlined = varOutlined
End Sub
...
AddAttr("persistent-hint", varPersistentHint)
mPersistentHint = varPersistentHint
End Sub

public Sub getPersistentHint() As Boolean
Return mPersistentHint
End Sub

public Sub setPlaceholder(varPlaceholder As String)
AddAttr("placeholder", varPlaceholder)
mPlaceholder = varPlaceholder
End Sub
...
public Sub setPrependInnerIcon(varPrependInnerIcon As String)
AddAttr("prepend-inner-icon", varPrependInnerIcon)
mPrependInnerIcon = varPrependInnerIcon
End Sub

public Sub getPrependInnerIcon() As String
Return mPrependInnerIcon
End Sub
...
public Sub setReturnObject(varReturnObject As Boolean)
AddAttr("return-object", varReturnObject)
mReturnObject = varReturnObject
End Sub

public Sub getReturnObject() As Boolean
...
public Sub setRules(varRules As List)
AddAttr("rules", varRules)
mRules = varRules
End Sub

public Sub getRules() As List
Return mRules
End Sub

public Sub setSearchInput(varSearchInput As String)
AddAttr("search-input", varSearchInput)
mSearchInput = varSearchInput
End Sub

public Sub getSearchInput() As String
Return mSearchInput
End Sub

public Sub setSegmented(varSegmented As Boolean)
AddAttr("segmented", varSegmented)
mSegmented = varSegmented
End Sub
...
AddAttr("single-line", varSingleLine)
mSingleLine = varSingleLine
End Sub
...
public Sub setSmallChips(varSmallChips As Boolean)
AddAttr("small-chips", varSmallChips)
mSmallChips = varSmallChips
End Sub

public Sub getSmallChips() As Boolean
Return mSmallChips
End Sub
...
public Sub setSoloInverted(varSoloInverted As Boolean)
AddAttr("solo-inverted", varSoloInverted)
mSoloInverted = varSoloInverted
End Sub

public Sub getSoloInverted() As Boolean
Return mSoloInverted
End Sub
...
public Sub setSuccessMessages(varSuccessMessages As String)
AddAttr("success-messages", varSuccessMessages)
mSuccessMessages = varSuccessMessages
End Sub

public Sub getSuccessMessages() As String
...
public Sub setValidateOnBlur(varValidateOnBlur As Boolean)
AddAttr("validate-on-blur", varValidateOnBlur)
mValidateOnBlur = varValidateOnBlur
End Sub

public Sub getValidateOnBlur() As Boolean
Return mValidateOnBlur
End Sub
...
public Sub setValueComparator(varValueComparator As String)
AddAttr("value-comparator", varValueComparator)
mValueComparator = varValueComparator
End Sub

public Sub getValueComparator() As String
...
If BANano.IsUndefined(eOnUpdateError) Or BANano.IsNull(eOnUpdateError) Then eOnUpdateError = ""
Dim sCode As String = $"${sName}(${eOnUpdateError})"$
AddAttr("v-on:update:error", sCode)
'arguments for the event
Dim argument As Boolean 'ignore
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument As Boolean))
methods.Put(sName, cb)
End Sub

Sub SetOnUpdateErrorE(sUpdateError As String)
