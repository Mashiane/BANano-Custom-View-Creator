...
#DesignerProperty: Key: Fullscreen, DisplayName: Fullscreen, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideOverlay, DisplayName: HideOverlay, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: MaxWidth, DisplayName: MaxWidth, FieldType: String, DefaultValue: none , Description: 
#DesignerProperty: Key: NoClickAnimation, DisplayName: NoClickAnimation, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Origin, DisplayName: Origin, FieldType: String, DefaultValue: center center , Description: 
#DesignerProperty: Key: OverlayColor, DisplayName: OverlayColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: OverlayOpacity, DisplayName: OverlayOpacity, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Persistent, DisplayName: Persistent, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: RetainFocus, DisplayName: RetainFocus, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: dialog-transition , Description: 
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: auto , Description: 
...
Private mHideOverlay As Boolean = False
Private mInternalActivator As Boolean = False
Private mKey As String = ""
Private mLight As Boolean = False
Private mMaxWidth As String = "none"
Private mNoClickAnimation As Boolean = False
Private mOpenDelay As String = "0"
Private mOpenOnFocus As Boolean = False
Private mOpenOnHover As Boolean = False
Private mOrigin As String = "center center"
Private mOverlayColor As String = ""
Private mOverlayOpacity As String = ""
Private mParentId As String = ""
Private mPersistent As Boolean = False
Private mRef As String = ""
Private mRetainFocus As Boolean = True
Private mReturnValue As String = ""
Private mScrollable As Boolean = False
Private mTransition As String = "dialog-transition"
...
mFullscreen = Props.Get("Fullscreen")
mHideOverlay = Props.Get("HideOverlay")
mInternalActivator = Props.Get("InternalActivator")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mMaxWidth = Props.Get("MaxWidth")
mNoClickAnimation = Props.Get("NoClickAnimation")
...
mOverlayColor = Props.Get("OverlayColor")
mOverlayOpacity = Props.Get("OverlayOpacity")
mParentId = Props.Get("ParentId")
mPersistent = Props.Get("Persistent")
mRef = Props.Get("Ref")
mRetainFocus = Props.Get("RetainFocus")
...
AddAttr("fullscreen", mFullscreen)
AddAttr("hide-overlay", mHideOverlay)
AddAttr("internal-activator", mInternalActivator)
AddAttr("key", mKey)
AddAttr("light", mLight)
AddAttr("max-width", mMaxWidth)
AddAttr("no-click-animation", mNoClickAnimation)
AddAttr("open-delay", mOpenDelay)
AddAttr("open-on-focus", mOpenOnFocus)
AddAttr("open-on-hover", mOpenOnHover)
AddAttr("origin", mOrigin)
AddAttr("overlay-color", mOverlayColor)
AddAttr("overlay-opacity", mOverlayOpacity)
AddAttr("parent-id", mParentId)
AddAttr("persistent", mPersistent)
AddAttr("ref", mRef)
AddAttr("retain-focus", mRetainFocus)
...
public Sub setHideOverlay(varHideOverlay As Boolean)
AddAttr("hide-overlay", varHideOverlay)
mHideOverlay = varHideOverlay
End Sub

public Sub getHideOverlay() As Boolean
Return mHideOverlay
End Sub
...
public Sub setNoClickAnimation(varNoClickAnimation As Boolean)
AddAttr("no-click-animation", varNoClickAnimation)
mNoClickAnimation = varNoClickAnimation
End Sub

public Sub getNoClickAnimation() As Boolean
Return mNoClickAnimation
End Sub
...
public Sub setOverlayColor(varOverlayColor As String)
AddAttr("overlay-color", varOverlayColor)
mOverlayColor = varOverlayColor
End Sub

public Sub getOverlayColor() As String
Return mOverlayColor
End Sub

public Sub setOverlayOpacity(varOverlayOpacity As String)
AddAttr("overlay-opacity", varOverlayOpacity)
mOverlayOpacity = varOverlayOpacity
End Sub

public Sub getOverlayOpacity() As String
...
public Sub setRetainFocus(varRetainFocus As Boolean)
AddAttr("retain-focus", varRetainFocus)
mRetainFocus = varRetainFocus
End Sub

public Sub getRetainFocus() As Boolean
Return mRetainFocus
End Sub
...
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument As BANanoEvent))
