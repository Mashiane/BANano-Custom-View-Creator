...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-window-item--active , Description: 
#DesignerProperty: Key: Continuous, DisplayName: Continuous, FieldType: Boolean, DefaultValue: True , Description: 
#DesignerProperty: Key: Cycle, DisplayName: Cycle, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Dark, DisplayName: Dark, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: DelimiterIcon, DisplayName: DelimiterIcon, FieldType: String, DefaultValue: $delimiter , Description: 
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 500 , Description: 
#DesignerProperty: Key: HideDelimiterBackground, DisplayName: HideDelimiterBackground, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideDelimiters, DisplayName: HideDelimiters, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Interval, DisplayName: Interval, FieldType: String, DefaultValue: 6000 , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Mandatory, DisplayName: Mandatory, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Progress, DisplayName: Progress, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ProgressColor, DisplayName: ProgressColor, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: ShowArrows, DisplayName: ShowArrows, FieldType: Boolean, DefaultValue: True , Description: 
#DesignerProperty: Key: ShowArrowsOnHover, DisplayName: ShowArrowsOnHover, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Touch, DisplayName: Touch, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: VerticalDelimiters, DisplayName: VerticalDelimiters, FieldType: String, DefaultValue:  , Description: 
...
Private mActiveClass As String = "v-window-item--active"
Private mContinuous As Boolean = True
Private mCycle As Boolean = False
Private mDark As Boolean = False
Private mDelimiterIcon As String = "$delimiter"
Private mHeight As String = "500"
Private mHideDelimiterBackground As Boolean = False
Private mHideDelimiters As Boolean = False
Private mInterval As String = "6000"
Private mKey As String = ""
Private mLight As Boolean = False
Private mMandatory As Boolean = True
...
Private mProgress As Boolean = False
Private mProgressColor As String = ""
Private mRef As String = ""
Private mReverse As Boolean = False
Private mShowArrows As Boolean = True
Private mShowArrowsOnHover As Boolean = False
Private mTouch As String = ""
...
Private mVerticalDelimiters As String = ""
...
mContinuous = Props.Get("Continuous")
mCycle = Props.Get("Cycle")
mDark = Props.Get("Dark")
mDelimiterIcon = Props.Get("DelimiterIcon")
mHeight = Props.Get("Height")
mHideDelimiterBackground = Props.Get("HideDelimiterBackground")
mHideDelimiters = Props.Get("HideDelimiters")
mInterval = Props.Get("Interval")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mMandatory = Props.Get("Mandatory")
mMax = Props.Get("Max")
...
mProgressColor = Props.Get("ProgressColor")
mRef = Props.Get("Ref")
mReverse = Props.Get("Reverse")
mShowArrows = Props.Get("ShowArrows")
mShowArrowsOnHover = Props.Get("ShowArrowsOnHover")
mTouch = Props.Get("Touch")
...
mVerticalDelimiters = Props.Get("VerticalDelimiters")
...
AddAttr("continuous", mContinuous)
AddAttr("cycle", mCycle)
AddAttr("dark", mDark)
AddAttr("delimiter-icon", mDelimiterIcon)
AddAttr("height", mHeight)
AddAttr("hide-delimiter-background", mHideDelimiterBackground)
AddAttr("hide-delimiters", mHideDelimiters)
AddAttr("interval", mInterval)
AddAttr("key", mKey)
AddAttr("light", mLight)
AddAttr("mandatory", mMandatory)
AddAttr("max", mMax)
...
AddAttr("progress-color", mProgressColor)
AddAttr("ref", mRef)
AddAttr("reverse", mReverse)
AddAttr("show-arrows", mShowArrows)
AddAttr("show-arrows-on-hover", mShowArrowsOnHover)
AddAttr("touch", mTouch)
...
AddAttr("vertical-delimiters", mVerticalDelimiters)
...
public Sub setDelimiterIcon(varDelimiterIcon As String)
AddAttr("delimiter-icon", varDelimiterIcon)
mDelimiterIcon = varDelimiterIcon
End Sub

public Sub getDelimiterIcon() As String
Return mDelimiterIcon
End Sub
...
public Sub setHideDelimiterBackground(varHideDelimiterBackground As Boolean)
AddAttr("hide-delimiter-background", varHideDelimiterBackground)
mHideDelimiterBackground = varHideDelimiterBackground
End Sub

public Sub getHideDelimiterBackground() As Boolean
Return mHideDelimiterBackground
End Sub

public Sub setHideDelimiters(varHideDelimiters As Boolean)
AddAttr("hide-delimiters", varHideDelimiters)
mHideDelimiters = varHideDelimiters
End Sub

public Sub getHideDelimiters() As Boolean
Return mHideDelimiters
End Sub

public Sub setInterval(varInterval As String)
AddAttr("interval", varInterval)
mInterval = varInterval
End Sub
...
public Sub setProgressColor(varProgressColor As String)
AddAttr("progress-color", varProgressColor)
mProgressColor = varProgressColor
End Sub
...
public Sub setShowArrows(varShowArrows As Boolean)
AddAttr("show-arrows", varShowArrows)
mShowArrows = varShowArrows
End Sub

public Sub getShowArrows() As Boolean
Return mShowArrows
End Sub

public Sub setShowArrowsOnHover(varShowArrowsOnHover As Boolean)
AddAttr("show-arrows-on-hover", varShowArrowsOnHover)
mShowArrowsOnHover = varShowArrowsOnHover
End Sub

public Sub getShowArrowsOnHover() As Boolean
Return mShowArrowsOnHover
End Sub
...
public Sub setVerticalDelimiters(varVerticalDelimiters As String)
AddAttr("vertical-delimiters", varVerticalDelimiters)
mVerticalDelimiters = varVerticalDelimiters
End Sub

public Sub getVerticalDelimiters() As String
Return mVerticalDelimiters
End Sub
...
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument As int))
