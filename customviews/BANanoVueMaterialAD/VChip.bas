...
#DesignerProperty: Key: Active, DisplayName: Active, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Close, DisplayName: Close, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: CloseIcon, DisplayName: CloseIcon, FieldType: String, DefaultValue: $delete , Description: 
...
#DesignerProperty: Key: Draggable, DisplayName: Draggable, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Filter, DisplayName: Filter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: FilterIcon, DisplayName: FilterIcon, FieldType: String, DefaultValue: $complete , Description: 
...
#DesignerProperty: Key: Label, DisplayName: Label, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Pill, DisplayName: Pill, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: TextColor, DisplayName: TextColor, FieldType: String, DefaultValue:  , Description: 
...
Private mClose As Boolean = False
Private mCloseIcon As String = "$delete"
Private mColor As String = ""
Private mDark As Boolean = False
Private mDisabled As Boolean = False
Private mDraggable As Boolean = False
Private mExact As Boolean = False
Private mExactActiveClass As String = ""
Private mFilter As Boolean = False
Private mFilterIcon As String = "$complete"
Private mHref As String = ""
Private mInputValue As String = ""
Private mKey As String = ""
Private mLabel As Boolean = False
...
Private mPill As Boolean = False
...
mClose = Props.Get("Close")
mCloseIcon = Props.Get("CloseIcon")
...
mFilterIcon = Props.Get("FilterIcon")
...
AddAttr("close", mClose)
AddAttr("close-icon", mCloseIcon)
...
AddAttr("filter-icon", mFilterIcon)
AddAttr("href", mHref)
...
public Sub setCloseIcon(varCloseIcon As String)
AddAttr("close-icon", varCloseIcon)
mCloseIcon = varCloseIcon
End Sub

public Sub getCloseIcon() As String
Return mCloseIcon
End Sub
...
public Sub setFilterIcon(varFilterIcon As String)
AddAttr("filter-icon", varFilterIcon)
mFilterIcon = varFilterIcon
End Sub

public Sub getFilterIcon() As String
Return mFilterIcon
End Sub
...
public Sub setTextColor(varTextColor As String)
AddAttr("text-color", varTextColor)
mTextColor = varTextColor
End Sub
