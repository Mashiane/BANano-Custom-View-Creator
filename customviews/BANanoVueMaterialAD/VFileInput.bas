...
#DesignerProperty: Key: Clearable, DisplayName: Clearable, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: CounterSizeString, DisplayName: CounterSizeString, FieldType: String, DefaultValue: $vuetify.fileInput.counterSize , Description: 
#DesignerProperty: Key: CounterString, DisplayName: CounterString, FieldType: String, DefaultValue: $vuetify.fileInput.counter , Description: 
...
#DesignerProperty: Key: HideInput, DisplayName: HideInput, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: PrependIcon, DisplayName: PrependIcon, FieldType: String, DefaultValue: $file , Description: 
...
#DesignerProperty: Key: ShowSize, DisplayName: ShowSize, FieldType: String, DefaultValue: false , Description: 
...
#DesignerProperty: Key: TruncateLength, DisplayName: TruncateLength, FieldType: String, DefaultValue: 22 , Description: 
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue: file , Description: 
...
Private mClearable As Boolean = True
Private mColor As String = ""
Private mCounter As String = ""
Private mCounterSizeString As String = "$vuetify.fileInput.counterSize"
Private mCounterString As String = "$vuetify.fileInput.counter"
...
Private mHideInput As Boolean = False
...
Private mPrependIcon As String = "$file"
...
Private mShowSize As String = "false"
...
Private mTruncateLength As String = "22"
Private mType As String = "file"
...
mCounterSizeString = Props.Get("CounterSizeString")
mCounterString = Props.Get("CounterString")
...
mHideInput = Props.Get("HideInput")
...
mTruncateLength = Props.Get("TruncateLength")
...
AddAttr("counter-size-string", mCounterSizeString)
AddAttr("counter-string", mCounterString)
...
AddAttr("truncate-length", mTruncateLength)
AddAttr("type", mType)
...
public Sub setCounterSizeString(varCounterSizeString As String)
AddAttr("counter-size-string", varCounterSizeString)
mCounterSizeString = varCounterSizeString
End Sub

public Sub getCounterSizeString() As String
Return mCounterSizeString
End Sub

public Sub setCounterString(varCounterString As String)
AddAttr("counter-string", varCounterString)
mCounterString = varCounterString
End Sub

public Sub getCounterString() As String
...
public Sub setHideInput(varHideInput As Boolean)
AddAttr("hide-input", varHideInput)
mHideInput = varHideInput
End Sub

public Sub getHideInput() As Boolean
Return mHideInput
End Sub
...
public Sub setShowSize(varShowSize As String)
AddAttr("show-size", varShowSize)
mShowSize = varShowSize
End Sub

public Sub getShowSize() As String
Return mShowSize
End Sub
...
public Sub setTruncateLength(varTruncateLength As String)
AddAttr("truncate-length", varTruncateLength)
mTruncateLength = varTruncateLength
End Sub

public Sub getTruncateLength() As String
Return mTruncateLength
End Sub
