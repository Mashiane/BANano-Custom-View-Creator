...
#DesignerProperty: Key: AllowedDates, DisplayName: AllowedDates, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: EventColor, DisplayName: EventColor, FieldType: String, DefaultValue: warning , Description: 
#DesignerProperty: Key: Events, DisplayName: Events, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: FirstDayOfWeek, DisplayName: FirstDayOfWeek, FieldType: String, DefaultValue: 0 , Description: 
...
#DesignerProperty: Key: HeaderDateFormat, DisplayName: HeaderDateFormat, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: NextIcon, DisplayName: NextIcon, FieldType: String, DefaultValue: $next , Description: 
#DesignerProperty: Key: NextMonthAriaLabel, DisplayName: NextMonthAriaLabel, FieldType: String, DefaultValue: $vuetify.datePicker.nextMonthAriaLabel , Description: 
#DesignerProperty: Key: NextYearAriaLabel, DisplayName: NextYearAriaLabel, FieldType: String, DefaultValue: $vuetify.datePicker.nextYearAriaLabel , Description: 
...
#DesignerProperty: Key: PickerDate, DisplayName: PickerDate, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: PrevIcon, DisplayName: PrevIcon, FieldType: String, DefaultValue: $prev , Description: 
#DesignerProperty: Key: PrevMonthAriaLabel, DisplayName: PrevMonthAriaLabel, FieldType: String, DefaultValue: $vuetify.datePicker.prevMonthAriaLabel , Description: 
#DesignerProperty: Key: PrevYearAriaLabel, DisplayName: PrevYearAriaLabel, FieldType: String, DefaultValue: $vuetify.datePicker.prevYearAriaLabel , Description: 
#DesignerProperty: Key: Range, DisplayName: Range, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Reactive, DisplayName: Reactive, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: SelectedItemsText, DisplayName: SelectedItemsText, FieldType: String, DefaultValue: $vuetify.datePicker.itemsSelected , Description: 
#DesignerProperty: Key: ShowCurrent, DisplayName: ShowCurrent, FieldType: String, DefaultValue: true , Description: 
#DesignerProperty: Key: ShowWeek, DisplayName: ShowWeek, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: TitleDateFormat, DisplayName: TitleDateFormat, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue: date , Description: 
...
#DesignerProperty: Key: YearFormat, DisplayName: YearFormat, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: YearIcon, DisplayName: YearIcon, FieldType: String, DefaultValue:  , Description: 
...
Private mAllowedDates As String = ""
...
Private mNextIcon As String = "$next"
Private mNextMonthAriaLabel As String = "$vuetify.datePicker.nextMonthAriaLabel"
Private mNextYearAriaLabel As String = "$vuetify.datePicker.nextYearAriaLabel"
Private mNoTitle As Boolean = False
Private mParentId As String = ""
Private mPickerDate As String = ""
Private mPrevIcon As String = "$prev"
Private mPrevMonthAriaLabel As String = "$vuetify.datePicker.prevMonthAriaLabel"
Private mPrevYearAriaLabel As String = "$vuetify.datePicker.prevYearAriaLabel"
Private mRange As Boolean = False
Private mReactive As Boolean = False
Private mReadonly As Boolean = False
Private mRef As String = ""
Private mScrollable As Boolean = False
Private mSelectedItemsText As String = "$vuetify.datePicker.itemsSelected"
Private mShowCurrent As String = "true"
Private mShowWeek As Boolean = False
Private mTitleDateFormat As String = ""
Private mType As String = "date"
...
Private mYearFormat As String = ""
Private mYearIcon As String = ""
...
mAllowedDates = Props.Get("AllowedDates")
...
mEvents = Props.Get("Events")
mFirstDayOfWeek = Props.Get("FirstDayOfWeek")
mFlat = Props.Get("Flat")
mFullWidth = Props.Get("FullWidth")
mHeaderColor = Props.Get("HeaderColor")
mHeaderDateFormat = Props.Get("HeaderDateFormat")
mKey = Props.Get("Key")
...
mNextIcon = Props.Get("NextIcon")
mNextMonthAriaLabel = Props.Get("NextMonthAriaLabel")
mNextYearAriaLabel = Props.Get("NextYearAriaLabel")
mNoTitle = Props.Get("NoTitle")
mParentId = Props.Get("ParentId")
mPickerDate = Props.Get("PickerDate")
mPrevIcon = Props.Get("PrevIcon")
mPrevMonthAriaLabel = Props.Get("PrevMonthAriaLabel")
mPrevYearAriaLabel = Props.Get("PrevYearAriaLabel")
mRange = Props.Get("Range")
mReactive = Props.Get("Reactive")
mReadonly = Props.Get("Readonly")
mRef = Props.Get("Ref")
mScrollable = Props.Get("Scrollable")
mSelectedItemsText = Props.Get("SelectedItemsText")
mShowCurrent = Props.Get("ShowCurrent")
mShowWeek = Props.Get("ShowWeek")
mTitleDateFormat = Props.Get("TitleDateFormat")
...
mYearFormat = Props.Get("YearFormat")
mYearIcon = Props.Get("YearIcon")
...
AddAttr("allowed-dates", mAllowedDates)
...
AddAttr("first-day-of-week", mFirstDayOfWeek)
AddAttr("flat", mFlat)
AddAttr("full-width", mFullWidth)
AddAttr("header-color", mHeaderColor)
AddAttr("header-date-format", mHeaderDateFormat)
AddAttr("key", mKey)
...
AddAttr("next-icon", mNextIcon)
AddAttr("next-month-aria-label", mNextMonthAriaLabel)
AddAttr("next-year-aria-label", mNextYearAriaLabel)
AddAttr("no-title", mNoTitle)
AddAttr("parent-id", mParentId)
AddAttr("picker-date", mPickerDate)
AddAttr("prev-icon", mPrevIcon)
AddAttr("prev-month-aria-label", mPrevMonthAriaLabel)
AddAttr("prev-year-aria-label", mPrevYearAriaLabel)
AddAttr("range", mRange)
AddAttr("reactive", mReactive)
AddAttr("readonly", mReadonly)
AddAttr("ref", mRef)
AddAttr("scrollable", mScrollable)
AddAttr("selected-items-text", mSelectedItemsText)
AddAttr("show-current", mShowCurrent)
AddAttr("show-week", mShowWeek)
AddAttr("title-date-format", mTitleDateFormat)
AddAttr("type", mType)
...
AddAttr("year-format", mYearFormat)
AddAttr("year-icon", mYearIcon)
...
public Sub setAllowedDates(varAllowedDates As String)
AddAttr("allowed-dates", varAllowedDates)
mAllowedDates = varAllowedDates
End Sub

public Sub getAllowedDates() As String
Return mAllowedDates
End Sub
...
public Sub setFirstDayOfWeek(varFirstDayOfWeek As String)
AddAttr("first-day-of-week", varFirstDayOfWeek)
mFirstDayOfWeek = varFirstDayOfWeek
End Sub

public Sub getFirstDayOfWeek() As String
...
public Sub setHeaderDateFormat(varHeaderDateFormat As String)
AddAttr("header-date-format", varHeaderDateFormat)
mHeaderDateFormat = varHeaderDateFormat
End Sub

public Sub getHeaderDateFormat() As String
...
public Sub setNextIcon(varNextIcon As String)
AddAttr("next-icon", varNextIcon)
mNextIcon = varNextIcon
End Sub

public Sub getNextIcon() As String
Return mNextIcon
End Sub

public Sub setNextMonthAriaLabel(varNextMonthAriaLabel As String)
AddAttr("next-month-aria-label", varNextMonthAriaLabel)
mNextMonthAriaLabel = varNextMonthAriaLabel
End Sub

public Sub getNextMonthAriaLabel() As String
Return mNextMonthAriaLabel
End Sub

public Sub setNextYearAriaLabel(varNextYearAriaLabel As String)
AddAttr("next-year-aria-label", varNextYearAriaLabel)
mNextYearAriaLabel = varNextYearAriaLabel
End Sub

public Sub getNextYearAriaLabel() As String
Return mNextYearAriaLabel
End Sub
...
public Sub setPickerDate(varPickerDate As String)
AddAttr("picker-date", varPickerDate)
mPickerDate = varPickerDate
End Sub

public Sub getPickerDate() As String
Return mPickerDate
End Sub

public Sub setPrevIcon(varPrevIcon As String)
AddAttr("prev-icon", varPrevIcon)
mPrevIcon = varPrevIcon
End Sub

public Sub getPrevIcon() As String
Return mPrevIcon
End Sub

public Sub setPrevMonthAriaLabel(varPrevMonthAriaLabel As String)
AddAttr("prev-month-aria-label", varPrevMonthAriaLabel)
mPrevMonthAriaLabel = varPrevMonthAriaLabel
End Sub

public Sub getPrevMonthAriaLabel() As String
Return mPrevMonthAriaLabel
End Sub

public Sub setPrevYearAriaLabel(varPrevYearAriaLabel As String)
AddAttr("prev-year-aria-label", varPrevYearAriaLabel)
mPrevYearAriaLabel = varPrevYearAriaLabel
End Sub

public Sub getPrevYearAriaLabel() As String
Return mPrevYearAriaLabel
End Sub
...
public Sub setSelectedItemsText(varSelectedItemsText As String)
AddAttr("selected-items-text", varSelectedItemsText)
mSelectedItemsText = varSelectedItemsText
End Sub

public Sub getSelectedItemsText() As String
Return mSelectedItemsText
End Sub

public Sub setShowCurrent(varShowCurrent As String)
AddAttr("show-current", varShowCurrent)
mShowCurrent = varShowCurrent
End Sub

public Sub getShowCurrent() As String
Return mShowCurrent
End Sub
...
public Sub setTitleDateFormat(varTitleDateFormat As String)
AddAttr("title-date-format", varTitleDateFormat)
mTitleDateFormat = varTitleDateFormat
End Sub

public Sub getTitleDateFormat() As String
Return mTitleDateFormat
End Sub
...
public Sub setYearFormat(varYearFormat As String)
AddAttr("year-format", varYearFormat)
mYearFormat = varYearFormat
End Sub

public Sub getYearFormat() As String
Return mYearFormat
End Sub

public Sub setYearIcon(varYearIcon As String)
AddAttr("year-icon", varYearIcon)
mYearIcon = varYearIcon
End Sub

public Sub getYearIcon() As String
Return mYearIcon
End Sub
