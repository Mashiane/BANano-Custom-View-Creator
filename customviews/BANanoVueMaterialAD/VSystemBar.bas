...
#DesignerProperty: Key: LightsOut, DisplayName: LightsOut, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Window, DisplayName: Window, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mLightsOut As Boolean = False
...
Private mWindow As Boolean = False
...
mLightsOut = Props.Get("LightsOut")
...
public Sub setLightsOut(varLightsOut As Boolean)
AddAttr("lights-out", varLightsOut)
mLightsOut = varLightsOut
End Sub

public Sub getLightsOut() As Boolean
Return mLightsOut
End Sub
