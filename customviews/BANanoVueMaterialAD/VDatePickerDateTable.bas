...
#DesignerProperty: Key: Current, DisplayName: Current, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Format, DisplayName: Format, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: TableDate, DisplayName: TableDate, FieldType: String, DefaultValue:  , Description: 
...
mTableDate = Props.Get("TableDate")
...
public Sub setCurrent(varCurrent As String)
AddAttr("current", varCurrent)
mCurrent = varCurrent
End Sub
...
public Sub setTableDate(varTableDate As String)
AddAttr("table-date", varTableDate)
mTableDate = varTableDate
End Sub

public Sub getTableDate() As String
Return mTableDate
End Sub
