...
#DesignerProperty: Key: AutoDraw, DisplayName: AutoDraw, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AutoDrawDuration, DisplayName: AutoDrawDuration, FieldType: String, DefaultValue: 2000 , Description: 
#DesignerProperty: Key: AutoDrawEasing, DisplayName: AutoDrawEasing, FieldType: String, DefaultValue: ease , Description: 
#DesignerProperty: Key: AutoLineWidth, DisplayName: AutoLineWidth, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: primary , Description: 
#DesignerProperty: Key: Fill, DisplayName: Fill, FieldType: Boolean, DefaultValue: False , Description: 

#DesignerProperty: Key: GradientDirection, DisplayName: GradientDirection, FieldType: String, DefaultValue: top , Description: 
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 75 , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: LabelSize, DisplayName: LabelSize, FieldType: String, DefaultValue: 7 , Description: 

#DesignerProperty: Key: LineWidth, DisplayName: LineWidth, FieldType: String, DefaultValue: 4 , Description: 
#DesignerProperty: Key: Padding, DisplayName: Padding, FieldType: String, DefaultValue: 8 , Description: 
...
#DesignerProperty: Key: ShowLabels, DisplayName: ShowLabels, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Smooth, DisplayName: Smooth, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue: trend , Description: 
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 300 , Description: 
...
Private mAutoDraw As Boolean = False
Private mAutoDrawDuration As String = "2000"
Private mAutoDrawEasing As String = "ease"
Private mAutoLineWidth As Boolean = False
Private mColor As String = "primary"
Private mFill As Boolean = False
Private mGradient As List
Private mGradientDirection As String = "top"
Private mHeight As String = "75"
Private mKey As String = ""
Private mLabelSize As String = "7"
Private mLabels As List
Private mLineWidth As String = "4"
Private mPadding As String = "8"
Private mParentId As String = ""
Private mRef As String = ""
Private mShowLabels As Boolean = False
Private mSmooth As String = "false"
Private mType As String = "trend"
...
mAutoDraw = Props.Get("AutoDraw")
mAutoDrawDuration = Props.Get("AutoDrawDuration")
mAutoDrawEasing = Props.Get("AutoDrawEasing")
mAutoLineWidth = Props.Get("AutoLineWidth")
mColor = Props.Get("Color")
mFill = Props.Get("Fill")
mGradientDirection = Props.Get("GradientDirection")
mHeight = Props.Get("Height")
mKey = Props.Get("Key")
mLabelSize = Props.Get("LabelSize")
mLineWidth = Props.Get("LineWidth")
mPadding = Props.Get("Padding")
mParentId = Props.Get("ParentId")
mRef = Props.Get("Ref")
mShowLabels = Props.Get("ShowLabels")
mSmooth = Props.Get("Smooth")
...
AddAttr("auto-draw", mAutoDraw)
AddAttr("auto-draw-duration", mAutoDrawDuration)
AddAttr("auto-draw-easing", mAutoDrawEasing)
AddAttr("auto-line-width", mAutoLineWidth)
AddAttr("color", mColor)
AddAttr("fill", mFill)
AddAttr("gradient", mGradient)
AddAttr("gradient-direction", mGradientDirection)
AddAttr("height", mHeight)
AddAttr("key", mKey)
AddAttr("label-size", mLabelSize)
AddAttr("labels", mLabels)
AddAttr("line-width", mLineWidth)
AddAttr("padding", mPadding)
AddAttr("parent-id", mParentId)
AddAttr("ref", mRef)
AddAttr("show-labels", mShowLabels)
AddAttr("smooth", mSmooth)
AddAttr("type", mType)
...
public Sub setAutoDraw(varAutoDraw As Boolean)
AddAttr("auto-draw", varAutoDraw)
mAutoDraw = varAutoDraw
End Sub

public Sub getAutoDraw() As Boolean
Return mAutoDraw
End Sub

public Sub setAutoDrawDuration(varAutoDrawDuration As String)
AddAttr("auto-draw-duration", varAutoDrawDuration)
mAutoDrawDuration = varAutoDrawDuration
End Sub

public Sub getAutoDrawDuration() As String
Return mAutoDrawDuration
End Sub

public Sub setAutoDrawEasing(varAutoDrawEasing As String)
AddAttr("auto-draw-easing", varAutoDrawEasing)
mAutoDrawEasing = varAutoDrawEasing
End Sub

public Sub getAutoDrawEasing() As String
Return mAutoDrawEasing
End Sub

public Sub setAutoLineWidth(varAutoLineWidth As Boolean)
AddAttr("auto-line-width", varAutoLineWidth)
mAutoLineWidth = varAutoLineWidth
End Sub

public Sub getAutoLineWidth() As Boolean
Return mAutoLineWidth
End Sub
...
public Sub setGradient(varGradient As List)
AddAttr("gradient", varGradient)
mGradient = varGradient
End Sub

public Sub getGradient() As List
Return mGradient
End Sub

public Sub setGradientDirection(varGradientDirection As String)
AddAttr("gradient-direction", varGradientDirection)
mGradientDirection = varGradientDirection
End Sub

public Sub getGradientDirection() As String
...
public Sub setLabelSize(varLabelSize As String)
AddAttr("label-size", varLabelSize)
mLabelSize = varLabelSize
End Sub

public Sub getLabelSize() As String
Return mLabelSize
End Sub

public Sub setLabels(varLabels As List)
AddAttr("labels", varLabels)
mLabels = varLabels
End Sub

public Sub getLabels() As List
Return mLabels
End Sub

public Sub setLineWidth(varLineWidth As String)
AddAttr("line-width", varLineWidth)
mLineWidth = varLineWidth
End Sub

public Sub getLineWidth() As String
Return mLineWidth
End Sub
...
public Sub setShowLabels(varShowLabels As Boolean)
AddAttr("show-labels", varShowLabels)
mShowLabels = varShowLabels
End Sub

public Sub getShowLabels() As Boolean
Return mShowLabels
End Sub
