...
#DesignerProperty: Key: Root, DisplayName: Root, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mRoot As Boolean = False
...
public Sub setRoot(varRoot As Boolean)
AddAttr("root", varRoot)
mRoot = varRoot
End Sub

public Sub getRoot() As Boolean
Return mRoot
End Sub
