...
#DesignerProperty: Key: Expand, DisplayName: Expand, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Nav, DisplayName: Nav, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Subheader, DisplayName: Subheader, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mExpand As Boolean = False
...
Private mSubheader As Boolean = False
...
mSubheader = Props.Get("Subheader")
mTag = Props.Get("Tag")
