...
#DesignerProperty: Key: HideOnLeave, DisplayName: HideOnLeave, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: LeaveAbsolute, DisplayName: LeaveAbsolute, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue: out-in , Description: 
...
Private mHideOnLeave As Boolean = False
Private mKey As String = ""
Private mLeaveAbsolute As Boolean = False
Private mMode As String = "out-in"
...
mHideOnLeave = Props.Get("HideOnLeave")
mKey = Props.Get("Key")
mLeaveAbsolute = Props.Get("LeaveAbsolute")
...
AddAttr("hide-on-leave", mHideOnLeave)
AddAttr("key", mKey)
AddAttr("leave-absolute", mLeaveAbsolute)
AddAttr("mode", mMode)
...
public Sub setHideOnLeave(varHideOnLeave As Boolean)
AddAttr("hide-on-leave", varHideOnLeave)
mHideOnLeave = varHideOnLeave
End Sub

public Sub getHideOnLeave() As Boolean
Return mHideOnLeave
End Sub
...
public Sub setLeaveAbsolute(varLeaveAbsolute As Boolean)
AddAttr("leave-absolute", varLeaveAbsolute)
mLeaveAbsolute = varLeaveAbsolute
End Sub

public Sub getLeaveAbsolute() As Boolean
Return mLeaveAbsolute
End Sub
