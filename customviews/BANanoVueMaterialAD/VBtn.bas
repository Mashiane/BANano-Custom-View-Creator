...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Append, DisplayName: Append, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Block, DisplayName: Block, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Depressed, DisplayName: Depressed, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Exact, DisplayName: Exact, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ExactActiveClass, DisplayName: ExactActiveClass, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Fab, DisplayName: Fab, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Icon, DisplayName: Icon, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Link, DisplayName: Link, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Nuxt, DisplayName: Nuxt, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Replace, DisplayName: Replace, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: RetainFocusOnClick, DisplayName: RetainFocusOnClick, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Right, DisplayName: Right, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: button , Description: 
#DesignerProperty: Key: Target, DisplayName: Target, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Text, DisplayName: Text, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Type, DisplayName: Type, FieldType: String, DefaultValue: button , Description: 
...
Private mLink As Boolean = False
...
mAppend = Props.Get("Append")
mBlock = Props.Get("Block")
mBottom = Props.Get("Bottom")
mColor = Props.Get("Color")
mDark = Props.Get("Dark")
mDepressed = Props.Get("Depressed")
mDisabled = Props.Get("Disabled")
mElevation = Props.Get("Elevation")
mExact = Props.Get("Exact")
mExactActiveClass = Props.Get("ExactActiveClass")
mFab = Props.Get("Fab")
...
mNuxt = Props.Get("Nuxt")
mOutlined = Props.Get("Outlined")
mParentId = Props.Get("ParentId")
mRef = Props.Get("Ref")
mReplace = Props.Get("Replace")
mRetainFocusOnClick = Props.Get("RetainFocusOnClick")
...
AddAttr("append", mAppend)
AddAttr("block", mBlock)
AddAttr("bottom", mBottom)
AddAttr("color", mColor)
AddAttr("dark", mDark)
AddAttr("depressed", mDepressed)
AddAttr("disabled", mDisabled)
AddAttr("elevation", mElevation)
AddAttr("exact", mExact)
AddAttr("exact-active-class", mExactActiveClass)
AddAttr("fab", mFab)
...
AddAttr("ref", mRef)
AddAttr("replace", mReplace)
AddAttr("retain-focus-on-click", mRetainFocusOnClick)
...
public Sub setExactActiveClass(varExactActiveClass As String)
AddAttr("exact-active-class", varExactActiveClass)
mExactActiveClass = varExactActiveClass
End Sub

public Sub getExactActiveClass() As String
Return mExactActiveClass
End Sub
...
public Sub setReplace(varReplace As Boolean)
AddAttr("replace", varReplace)
mReplace = varReplace
End Sub

public Sub getReplace() As Boolean
Return mReplace
End Sub

public Sub setRetainFocusOnClick(varRetainFocusOnClick As Boolean)
AddAttr("retain-focus-on-click", varRetainFocusOnClick)
mRetainFocusOnClick = varRetainFocusOnClick
End Sub

public Sub getRetainFocusOnClick() As Boolean
Return mRetainFocusOnClick
End Sub
