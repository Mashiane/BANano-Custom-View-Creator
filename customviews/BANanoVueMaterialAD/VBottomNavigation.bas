...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-btn--active , Description: 
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 56 , Description: 
#DesignerProperty: Key: HideOnScroll, DisplayName: HideOnScroll, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Horizontal, DisplayName: Horizontal, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: InputValue, DisplayName: InputValue, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Shift, DisplayName: Shift, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mActiveClass As String = "v-btn--active"
...
Private mShift As Boolean = False
...
AddAttr("horizontal", mHorizontal)
...
public Sub setInputValue(varInputValue As Boolean)
AddAttr("input-value", varInputValue)
mInputValue = varInputValue
End Sub

public Sub getInputValue() As Boolean
Return mInputValue
End Sub
