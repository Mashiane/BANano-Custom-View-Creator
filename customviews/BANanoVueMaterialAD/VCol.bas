...
#DesignerProperty: Key: AlignSelf, DisplayName: AlignSelf, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Cols, DisplayName: Cols, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Lg, DisplayName: Lg, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: Md, DisplayName: Md, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: Offset, DisplayName: Offset, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Order, DisplayName: Order, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: OrderLg, DisplayName: OrderLg, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: OrderMd, DisplayName: OrderMd, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: OrderSm, DisplayName: OrderSm, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: OrderXl, DisplayName: OrderXl, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Sm, DisplayName: Sm, FieldType: String, DefaultValue: false , Description: 
...
#DesignerProperty: Key: Xl, DisplayName: Xl, FieldType: String, DefaultValue: false , Description: 
...
Private mCols As String = "false"
Private mKey As String = ""
Private mLg As String = "false"
Private mMd As String = "false"
Private mOffset As String = ""
Private mOffsetLg As String = ""
Private mOffsetMd As String = ""
Private mOffsetSm As String = ""
Private mOffsetXl As String = ""
Private mOrder As String = ""
Private mOrderLg As String = ""
Private mOrderMd As String = ""
Private mOrderSm As String = ""
Private mOrderXl As String = ""
Private mParentId As String = ""
Private mRef As String = ""
Private mSm As String = "false"
...
mLg = Props.Get("Lg")
mMd = Props.Get("Md")
mOffset = Props.Get("Offset")
mOffsetLg = Props.Get("OffsetLg")
mOffsetMd = Props.Get("OffsetMd")
mOffsetSm = Props.Get("OffsetSm")
mOffsetXl = Props.Get("OffsetXl")
mOrder = Props.Get("Order")
mOrderLg = Props.Get("OrderLg")
mOrderMd = Props.Get("OrderMd")
mOrderSm = Props.Get("OrderSm")
mOrderXl = Props.Get("OrderXl")
...
AddAttr("align-self", mAlignSelf)
AddAttr("cols", mCols)
AddAttr("key", mKey)
AddAttr("lg", mLg)
AddAttr("md", mMd)
AddAttr("offset", mOffset)
AddAttr("offset-lg", mOffsetLg)
AddAttr("offset-md", mOffsetMd)
AddAttr("offset-sm", mOffsetSm)
AddAttr("offset-xl", mOffsetXl)
AddAttr("order", mOrder)
AddAttr("order-lg", mOrderLg)
AddAttr("order-md", mOrderMd)
AddAttr("order-sm", mOrderSm)
AddAttr("order-xl", mOrderXl)
...
public Sub setAlignSelf(varAlignSelf As String)
AddAttr("align-self", varAlignSelf)
mAlignSelf = varAlignSelf
End Sub

public Sub getAlignSelf() As String
Return mAlignSelf
End Sub
...
public Sub setOffsetLg(varOffsetLg As String)
AddAttr("offset-lg", varOffsetLg)
mOffsetLg = varOffsetLg
End Sub

public Sub getOffsetLg() As String
Return mOffsetLg
End Sub

public Sub setOffsetMd(varOffsetMd As String)
AddAttr("offset-md", varOffsetMd)
mOffsetMd = varOffsetMd
End Sub

public Sub getOffsetMd() As String
Return mOffsetMd
End Sub

public Sub setOffsetSm(varOffsetSm As String)
AddAttr("offset-sm", varOffsetSm)
mOffsetSm = varOffsetSm
End Sub

public Sub getOffsetSm() As String
Return mOffsetSm
End Sub

public Sub setOffsetXl(varOffsetXl As String)
AddAttr("offset-xl", varOffsetXl)
mOffsetXl = varOffsetXl
End Sub

public Sub getOffsetXl() As String
Return mOffsetXl
End Sub
...
public Sub setOrderLg(varOrderLg As String)
AddAttr("order-lg", varOrderLg)
mOrderLg = varOrderLg
End Sub

public Sub getOrderLg() As String
Return mOrderLg
End Sub

public Sub setOrderMd(varOrderMd As String)
AddAttr("order-md", varOrderMd)
mOrderMd = varOrderMd
End Sub

public Sub getOrderMd() As String
Return mOrderMd
End Sub

public Sub setOrderSm(varOrderSm As String)
AddAttr("order-sm", varOrderSm)
mOrderSm = varOrderSm
End Sub

public Sub getOrderSm() As String
Return mOrderSm
End Sub

public Sub setOrderXl(varOrderXl As String)
AddAttr("order-xl", varOrderXl)
mOrderXl = varOrderXl
End Sub

public Sub getOrderXl() As String
Return mOrderXl
End Sub
