...
#DesignerProperty: Key: BackgroundOpacity, DisplayName: BackgroundOpacity, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Bottom, DisplayName: Bottom, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: BufferValue, DisplayName: BufferValue, FieldType: String, DefaultValue: 100 , Description: 
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 4 , Description: 
...
#DesignerProperty: Key: Query, DisplayName: Query, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Stream, DisplayName: Stream, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Striped, DisplayName: Striped, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mStream As Boolean = False
Private mStriped As Boolean = False
...
mBackgroundOpacity = Props.Get("BackgroundOpacity")
mBottom = Props.Get("Bottom")
mBufferValue = Props.Get("BufferValue")
...
mQuery = Props.Get("Query")
mRef = Props.Get("Ref")
mReverse = Props.Get("Reverse")
mRounded = Props.Get("Rounded")
mStream = Props.Get("Stream")
mStriped = Props.Get("Striped")
mTop = Props.Get("Top")
...
AddAttr("background-opacity", mBackgroundOpacity)
AddAttr("bottom", mBottom)
AddAttr("buffer-value", mBufferValue)
...
AddAttr("query", mQuery)
AddAttr("ref", mRef)
AddAttr("reverse", mReverse)
AddAttr("rounded", mRounded)
AddAttr("stream", mStream)
AddAttr("striped", mStriped)
AddAttr("top", mTop)
...
public Sub setBackgroundOpacity(varBackgroundOpacity As String)
AddAttr("background-opacity", varBackgroundOpacity)
mBackgroundOpacity = varBackgroundOpacity
End Sub

public Sub getBackgroundOpacity() As String
...
public Sub setBufferValue(varBufferValue As String)
AddAttr("buffer-value", varBufferValue)
mBufferValue = varBufferValue
End Sub

public Sub getBufferValue() As String
Return mBufferValue
End Sub
