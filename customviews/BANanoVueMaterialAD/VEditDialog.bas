...
#DesignerProperty: Key: CancelText, DisplayName: CancelText, FieldType: String, DefaultValue: Cancel , Description: 
...
#DesignerProperty: Key: SaveText, DisplayName: SaveText, FieldType: String, DefaultValue: Save , Description: 
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: slide-x-reverse-transition , Description: 
...
Private mCancelText As String = "Cancel"
...
Private mSaveText As String = "Save"
Private mTransition As String = "slide-x-reverse-transition"
...
mCancelText = Props.Get("CancelText")
...
AddAttr("cancel-text", mCancelText)
AddAttr("dark", mDark)
...
public Sub setCancelText(varCancelText As String)
AddAttr("cancel-text", varCancelText)
mCancelText = varCancelText
End Sub

public Sub getCancelText() As String
Return mCancelText
End Sub
...
public Sub setSaveText(varSaveText As String)
AddAttr("save-text", varSaveText)
mSaveText = varSaveText
End Sub

public Sub getSaveText() As String
Return mSaveText
End Sub
