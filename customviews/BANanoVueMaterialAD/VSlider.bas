...
#DesignerProperty: Key: InverseLabel, DisplayName: InverseLabel, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Max, DisplayName: Max, FieldType: String, DefaultValue: 100 , Description: 
#DesignerProperty: Key: Messages, DisplayName: Messages, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Min, DisplayName: Min, FieldType: String, DefaultValue: 0 , Description: 
...
#DesignerProperty: Key: Step, DisplayName: Step, FieldType: String, DefaultValue: 1 , Description: 
...
#DesignerProperty: Key: ThumbColor, DisplayName: ThumbColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ThumbLabel, DisplayName: ThumbLabel, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ThumbSize, DisplayName: ThumbSize, FieldType: String, DefaultValue: 32 , Description: 

#DesignerProperty: Key: TickSize, DisplayName: TickSize, FieldType: String, DefaultValue: 2 , Description: 
#DesignerProperty: Key: Ticks, DisplayName: Ticks, FieldType: String, DefaultValue: false , Description: 
#DesignerProperty: Key: TrackColor, DisplayName: TrackColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: TrackFillColor, DisplayName: TrackFillColor, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Vertical, DisplayName: Vertical, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mStep As String = "1"
Private mSuccess As Boolean = False
Private mSuccessMessages As String = ""
Private mThumbColor As String = ""
Private mThumbLabel As String = ""
Private mThumbSize As String = "32"
Private mTickLabels As List
Private mTickSize As String = "2"
Private mTicks As String = "false"
Private mTrackColor As String = ""
Private mTrackFillColor As String = ""
...
Private mVertical As Boolean = False
...
mId = Props.Get("Id")
mInverseLabel = Props.Get("InverseLabel")
mKey = Props.Get("Key")
...
mRef = Props.Get("Ref")
mStep = Props.Get("Step")
mSuccess = Props.Get("Success")
mSuccessMessages = Props.Get("SuccessMessages")
mThumbColor = Props.Get("ThumbColor")
mThumbLabel = Props.Get("ThumbLabel")
mThumbSize = Props.Get("ThumbSize")
mTickSize = Props.Get("TickSize")
mTicks = Props.Get("Ticks")
mTrackColor = Props.Get("TrackColor")
mTrackFillColor = Props.Get("TrackFillColor")
...
AddAttr("hint", mHint)
AddAttr("id", mId)
AddAttr("inverse-label", mInverseLabel)
AddAttr("key", mKey)
...
AddAttr("thumb-color", mThumbColor)
AddAttr("thumb-label", mThumbLabel)
AddAttr("thumb-size", mThumbSize)
AddAttr("tick-labels", mTickLabels)
AddAttr("tick-size", mTickSize)
AddAttr("ticks", mTicks)
AddAttr("track-color", mTrackColor)
AddAttr("track-fill-color", mTrackFillColor)
...
public Sub setInverseLabel(varInverseLabel As Boolean)
AddAttr("inverse-label", varInverseLabel)
mInverseLabel = varInverseLabel
End Sub

public Sub getInverseLabel() As Boolean
Return mInverseLabel
End Sub
...
public Sub setThumbColor(varThumbColor As String)
AddAttr("thumb-color", varThumbColor)
mThumbColor = varThumbColor
End Sub

public Sub getThumbColor() As String
Return mThumbColor
End Sub

public Sub setThumbLabel(varThumbLabel As String)
AddAttr("thumb-label", varThumbLabel)
mThumbLabel = varThumbLabel
End Sub

public Sub getThumbLabel() As String
Return mThumbLabel
End Sub

public Sub setThumbSize(varThumbSize As String)
AddAttr("thumb-size", varThumbSize)
mThumbSize = varThumbSize
End Sub

public Sub getThumbSize() As String
Return mThumbSize
End Sub

public Sub setTickLabels(varTickLabels As List)
AddAttr("tick-labels", varTickLabels)
mTickLabels = varTickLabels
End Sub

public Sub getTickLabels() As List
Return mTickLabels
End Sub

public Sub setTickSize(varTickSize As String)
AddAttr("tick-size", varTickSize)
mTickSize = varTickSize
End Sub

public Sub getTickSize() As String
Return mTickSize
End Sub
...
public Sub setTrackColor(varTrackColor As String)
AddAttr("track-color", varTrackColor)
mTrackColor = varTrackColor
End Sub

public Sub getTrackColor() As String
Return mTrackColor
End Sub

public Sub setTrackFillColor(varTrackFillColor As String)
AddAttr("track-fill-color", varTrackFillColor)
mTrackFillColor = varTrackFillColor
End Sub

public Sub getTrackFillColor() As String
Return mTrackFillColor
End Sub
