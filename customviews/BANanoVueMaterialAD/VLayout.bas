...
#DesignerProperty: Key: AlignBaseline, DisplayName: AlignBaseline, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignCenter, DisplayName: AlignCenter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignContentCenter, DisplayName: AlignContentCenter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignContentEnd, DisplayName: AlignContentEnd, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignContentSpaceAround, DisplayName: AlignContentSpaceAround, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignContentSpaceBetween, DisplayName: AlignContentSpaceBetween, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignContentStart, DisplayName: AlignContentStart, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignEnd, DisplayName: AlignEnd, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AlignStart, DisplayName: AlignStart, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: FillHeight, DisplayName: FillHeight, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Id, DisplayName: Id, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: JustifyCenter, DisplayName: JustifyCenter, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: JustifyEnd, DisplayName: JustifyEnd, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: JustifySpaceAround, DisplayName: JustifySpaceAround, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: JustifySpaceBetween, DisplayName: JustifySpaceBetween, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: JustifyStart, DisplayName: JustifyStart, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: div , Description: 
#DesignerProperty: Key: Undefined, DisplayName: Undefined, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAlignBaseline As Boolean = False
Private mAlignCenter As Boolean = False
Private mAlignContentCenter As Boolean = False
Private mAlignContentEnd As Boolean = False
Private mAlignContentSpaceAround As Boolean = False
Private mAlignContentSpaceBetween As Boolean = False
Private mAlignContentStart As Boolean = False
Private mAlignEnd As Boolean = False
Private mAlignStart As Boolean = False
Private mColumn As Boolean = False
Private mFillHeight As Boolean = False
Private mId As String = ""
Private mJustifyCenter As Boolean = False
Private mJustifyEnd As Boolean = False
Private mJustifySpaceAround As Boolean = False
Private mJustifySpaceBetween As Boolean = False
Private mJustifyStart As Boolean = False
Private mKey As String = ""
Private mParentId As String = ""
Private mRef As String = ""
Private mReverse As Boolean = False
Private mRow As Boolean = True
Private mTag As String = "div"
Private mUndefined As Boolean = False
...
Private mWrap As Boolean = False
...
mAlignBaseline = Props.Get("AlignBaseline")
mAlignCenter = Props.Get("AlignCenter")
mAlignContentCenter = Props.Get("AlignContentCenter")
mAlignContentEnd = Props.Get("AlignContentEnd")
mAlignContentSpaceAround = Props.Get("AlignContentSpaceAround")
mAlignContentSpaceBetween = Props.Get("AlignContentSpaceBetween")
mAlignContentStart = Props.Get("AlignContentStart")
mAlignEnd = Props.Get("AlignEnd")
mAlignStart = Props.Get("AlignStart")
mColumn = Props.Get("Column")
mFillHeight = Props.Get("FillHeight")
mId = Props.Get("Id")
mJustifyCenter = Props.Get("JustifyCenter")
mJustifyEnd = Props.Get("JustifyEnd")
mJustifySpaceAround = Props.Get("JustifySpaceAround")
mJustifySpaceBetween = Props.Get("JustifySpaceBetween")
mJustifyStart = Props.Get("JustifyStart")
mKey = Props.Get("Key")
...
mRow = Props.Get("Row")
mTag = Props.Get("Tag")
mUndefined = Props.Get("Undefined")
...
AddAttr("align-baseline", mAlignBaseline)
AddAttr("align-center", mAlignCenter)
AddAttr("align-content-center", mAlignContentCenter)
AddAttr("align-content-end", mAlignContentEnd)
AddAttr("align-content-space-around", mAlignContentSpaceAround)
AddAttr("align-content-space-between", mAlignContentSpaceBetween)
AddAttr("align-content-start", mAlignContentStart)
AddAttr("align-end", mAlignEnd)
AddAttr("align-start", mAlignStart)
AddAttr("column", mColumn)
AddAttr("fill-height", mFillHeight)
AddAttr("id", mId)
AddAttr("justify-center", mJustifyCenter)
AddAttr("justify-end", mJustifyEnd)
AddAttr("justify-space-around", mJustifySpaceAround)
AddAttr("justify-space-between", mJustifySpaceBetween)
AddAttr("justify-start", mJustifyStart)
AddAttr("key", mKey)
...
public Sub setAlignBaseline(varAlignBaseline As Boolean)
AddAttr("align-baseline", varAlignBaseline)
mAlignBaseline = varAlignBaseline
End Sub

public Sub getAlignBaseline() As Boolean
Return mAlignBaseline
End Sub

public Sub setAlignCenter(varAlignCenter As Boolean)
AddAttr("align-center", varAlignCenter)
...
public Sub setAlignContentCenter(varAlignContentCenter As Boolean)
AddAttr("align-content-center", varAlignContentCenter)
mAlignContentCenter = varAlignContentCenter
End Sub

public Sub getAlignContentCenter() As Boolean
Return mAlignContentCenter
End Sub

public Sub setAlignContentEnd(varAlignContentEnd As Boolean)
AddAttr("align-content-end", varAlignContentEnd)
mAlignContentEnd = varAlignContentEnd
End Sub

public Sub getAlignContentEnd() As Boolean
Return mAlignContentEnd
End Sub

public Sub setAlignContentSpaceAround(varAlignContentSpaceAround As Boolean)
AddAttr("align-content-space-around", varAlignContentSpaceAround)
mAlignContentSpaceAround = varAlignContentSpaceAround
End Sub

public Sub getAlignContentSpaceAround() As Boolean
Return mAlignContentSpaceAround
End Sub

public Sub setAlignContentSpaceBetween(varAlignContentSpaceBetween As Boolean)
AddAttr("align-content-space-between", varAlignContentSpaceBetween)
mAlignContentSpaceBetween = varAlignContentSpaceBetween
End Sub

public Sub getAlignContentSpaceBetween() As Boolean
Return mAlignContentSpaceBetween
End Sub

public Sub setAlignContentStart(varAlignContentStart As Boolean)
AddAttr("align-content-start", varAlignContentStart)
mAlignContentStart = varAlignContentStart
End Sub

public Sub getAlignContentStart() As Boolean
Return mAlignContentStart
End Sub

public Sub setAlignEnd(varAlignEnd As Boolean)
AddAttr("align-end", varAlignEnd)
mAlignEnd = varAlignEnd
End Sub

public Sub getAlignEnd() As Boolean
Return mAlignEnd
End Sub

public Sub setAlignStart(varAlignStart As Boolean)
AddAttr("align-start", varAlignStart)
mAlignStart = varAlignStart
End Sub

public Sub getAlignStart() As Boolean
Return mAlignStart
End Sub
...
AddAttr("fill-height", varFillHeight)
mFillHeight = varFillHeight
End Sub
...
AddAttr("justify-center", varJustifyCenter)
mJustifyCenter = varJustifyCenter
End Sub

public Sub getJustifyCenter() As Boolean
Return mJustifyCenter
End Sub

public Sub setJustifyEnd(varJustifyEnd As Boolean)
AddAttr("justify-end", varJustifyEnd)
mJustifyEnd = varJustifyEnd
End Sub

public Sub getJustifyEnd() As Boolean
Return mJustifyEnd
End Sub

public Sub setJustifySpaceAround(varJustifySpaceAround As Boolean)
AddAttr("justify-space-around", varJustifySpaceAround)
mJustifySpaceAround = varJustifySpaceAround
End Sub

public Sub getJustifySpaceAround() As Boolean
Return mJustifySpaceAround
End Sub

public Sub setJustifySpaceBetween(varJustifySpaceBetween As Boolean)
AddAttr("justify-space-between", varJustifySpaceBetween)
mJustifySpaceBetween = varJustifySpaceBetween
End Sub

public Sub getJustifySpaceBetween() As Boolean
Return mJustifySpaceBetween
End Sub

public Sub setJustifyStart(varJustifyStart As Boolean)
AddAttr("justify-start", varJustifyStart)
mJustifyStart = varJustifyStart
End Sub

public Sub getJustifyStart() As Boolean
Return mJustifyStart
End Sub
...
public Sub setUndefined(varUndefined As Boolean)
AddAttr("undefined", varUndefined)
mUndefined = varUndefined
End Sub

public Sub getUndefined() As Boolean
Return mUndefined
End Sub
