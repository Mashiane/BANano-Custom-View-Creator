...
#DesignerProperty: Key: Item, DisplayName: Item, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Level, DisplayName: Level, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: ParentIsDisabled, DisplayName: ParentIsDisabled, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mParentIsDisabled As Boolean = False
...
mParentIsDisabled = Props.Get("ParentIsDisabled")
mRef = Props.Get("Ref")
...
AddAttr("parent-is-disabled", mParentIsDisabled)
AddAttr("ref", mRef)
...
public Sub setParentIsDisabled(varParentIsDisabled As Boolean)
AddAttr("parent-is-disabled", varParentIsDisabled)
mParentIsDisabled = varParentIsDisabled
End Sub

public Sub getParentIsDisabled() As Boolean
Return mParentIsDisabled
End Sub
