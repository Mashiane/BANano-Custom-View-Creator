...
#DesignerProperty: Key: OffIcon, DisplayName: OffIcon, FieldType: String, DefaultValue: $radioOff , Description: 
#DesignerProperty: Key: OnIcon, DisplayName: OnIcon, FieldType: String, DefaultValue: $radioOn , Description: 
...
Private mOffIcon As String = "$radioOff"
Private mOnIcon As String = "$radioOn"
