...
#DesignerProperty: Key: AppendIcon, DisplayName: AppendIcon, FieldType: String, DefaultValue: $expand , Description: 
...
#DesignerProperty: Key: NoAction, DisplayName: NoAction, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: SubGroup, DisplayName: SubGroup, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAppendIcon As String = "$expand"
...
public Sub setNoAction(varNoAction As Boolean)
AddAttr("no-action", varNoAction)
mNoAction = varNoAction
End Sub

public Sub getNoAction() As Boolean
Return mNoAction
End Sub
...
public Sub setSubGroup(varSubGroup As Boolean)
AddAttr("sub-group", varSubGroup)
mSubGroup = varSubGroup
End Sub

public Sub getSubGroup() As Boolean
Return mSubGroup
End Sub
