...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-item--active , Description: 
...
#DesignerProperty: Key: Column, DisplayName: Column, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: auto , Description: 
...
#DesignerProperty: Key: Mandatory, DisplayName: Mandatory, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Row, DisplayName: Row, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mActiveClass As String = "v-item--active"
Private mAppendIcon As String = ""
Private mBackgroundColor As String = ""
Private mColor As String = ""
Private mColumn As Boolean = True
...
Private mMandatory As Boolean = False
