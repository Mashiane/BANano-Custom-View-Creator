...
#DesignerProperty: Key: Borderless, DisplayName: Borderless, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Group, DisplayName: Group, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mBorderless As Boolean = False
Private mColor As String = ""
Private mDark As Boolean = False
Private mDense As Boolean = False
Private mGroup As Boolean = False
...
mBorderless = Props.Get("Borderless")
...
AddAttr("borderless", mBorderless)
