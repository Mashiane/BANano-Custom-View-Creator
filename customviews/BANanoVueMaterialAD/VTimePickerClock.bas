...
#DesignerProperty: Key: AllowedValues, DisplayName: AllowedValues, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Double, DisplayName: Double, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Rotate, DisplayName: Rotate, FieldType: String, DefaultValue: 0 , Description: 
...
Private mDouble As Boolean = False
...
AddAttr("allowed-values", mAllowedValues)
AddAttr("ampm", mAmpm)
AddAttr("color", mColor)
AddAttr("dark", mDark)
AddAttr("disabled", mDisabled)
AddAttr("double", mDouble)
...
public Sub setAllowedValues(varAllowedValues As String)
AddAttr("allowed-values", varAllowedValues)
mAllowedValues = varAllowedValues
End Sub

public Sub getAllowedValues() As String
...
public Sub setDouble(varDouble As Boolean)
AddAttr("double", varDouble)
mDouble = varDouble
End Sub

public Sub getDouble() As Boolean
Return mDouble
End Sub
