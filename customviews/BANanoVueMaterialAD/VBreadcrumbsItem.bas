...
#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-breadcrumbs__item--disabled , Description: 
...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: String, DefaultValue: false , Description: 
...
Private mActiveClass As String = "v-breadcrumbs__item--disabled"
...
Private mRipple As String = "false"
