...
#DesignerProperty: Key: Clipped, DisplayName: Clipped, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: DisableResizeWatcher, DisplayName: DisableResizeWatcher, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: DisableRouteWatcher, DisplayName: DisableRouteWatcher, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ExpandOnHover, DisplayName: ExpandOnHover, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue: 100% , Description: 
...
#DesignerProperty: Key: MiniVariant, DisplayName: MiniVariant, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: MiniVariantWidth, DisplayName: MiniVariantWidth, FieldType: String, DefaultValue: 56 , Description: 
#DesignerProperty: Key: MobileBreakpoint, DisplayName: MobileBreakpoint, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Permanent, DisplayName: Permanent, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Stateless, DisplayName: Stateless, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Tag, DisplayName: Tag, FieldType: String, DefaultValue: aside , Description: 
#DesignerProperty: Key: Temporary, DisplayName: Temporary, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Touchless, DisplayName: Touchless, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Width, DisplayName: Width, FieldType: String, DefaultValue: 256 , Description: 
...
Private mClipped As Boolean = False
Private mColor As String = ""
Private mDark As Boolean = False
Private mDisableResizeWatcher As Boolean = False
Private mDisableRouteWatcher As Boolean = False
Private mExpandOnHover As Boolean = False
Private mFixed As Boolean = False
Private mFloating As Boolean = False
Private mHeight As String = "100%"
Private mHideOverlay As Boolean = False
Private mKey As String = ""
Private mLight As Boolean = False
Private mMiniVariant As Boolean = False
Private mMiniVariantWidth As String = "56"
Private mMobileBreakpoint As String = ""
Private mOverlayColor As String = ""
Private mOverlayOpacity As String = ""
Private mParentId As String = ""
Private mPermanent As Boolean = False
Private mRef As String = ""
Private mRight As Boolean = False
Private mSrc As String = ""
Private mStateless As Boolean = False
Private mTag As String = "aside"
Private mTemporary As Boolean = False
Private mTouchless As Boolean = False
...
mClipped = Props.Get("Clipped")
mColor = Props.Get("Color")
mDark = Props.Get("Dark")
mDisableResizeWatcher = Props.Get("DisableResizeWatcher")
mDisableRouteWatcher = Props.Get("DisableRouteWatcher")
mExpandOnHover = Props.Get("ExpandOnHover")
...
mMiniVariant = Props.Get("MiniVariant")
mMiniVariantWidth = Props.Get("MiniVariantWidth")
...
mPermanent = Props.Get("Permanent")
mRef = Props.Get("Ref")
mRight = Props.Get("Right")
mSrc = Props.Get("Src")
mStateless = Props.Get("Stateless")
mTag = Props.Get("Tag")
mTemporary = Props.Get("Temporary")
mTouchless = Props.Get("Touchless")
...
AddAttr("clipped", mClipped)
AddAttr("color", mColor)
AddAttr("dark", mDark)
AddAttr("disable-resize-watcher", mDisableResizeWatcher)
AddAttr("disable-route-watcher", mDisableRouteWatcher)
AddAttr("expand-on-hover", mExpandOnHover)
...
AddAttr("mini-variant", mMiniVariant)
AddAttr("mini-variant-width", mMiniVariantWidth)
...
AddAttr("permanent", mPermanent)
AddAttr("ref", mRef)
AddAttr("right", mRight)
AddAttr("src", mSrc)
AddAttr("stateless", mStateless)
AddAttr("tag", mTag)
AddAttr("temporary", mTemporary)
AddAttr("touchless", mTouchless)
...
public Sub setDisableResizeWatcher(varDisableResizeWatcher As Boolean)
AddAttr("disable-resize-watcher", varDisableResizeWatcher)
mDisableResizeWatcher = varDisableResizeWatcher
End Sub

public Sub getDisableResizeWatcher() As Boolean
Return mDisableResizeWatcher
End Sub

public Sub setDisableRouteWatcher(varDisableRouteWatcher As Boolean)
AddAttr("disable-route-watcher", varDisableRouteWatcher)
mDisableRouteWatcher = varDisableRouteWatcher
End Sub

public Sub getDisableRouteWatcher() As Boolean
Return mDisableRouteWatcher
End Sub

public Sub setExpandOnHover(varExpandOnHover As Boolean)
AddAttr("expand-on-hover", varExpandOnHover)
mExpandOnHover = varExpandOnHover
End Sub

public Sub getExpandOnHover() As Boolean
Return mExpandOnHover
End Sub
...
public Sub setMiniVariant(varMiniVariant As Boolean)
AddAttr("mini-variant", varMiniVariant)
mMiniVariant = varMiniVariant
End Sub

public Sub getMiniVariant() As Boolean
Return mMiniVariant
End Sub

public Sub setMiniVariantWidth(varMiniVariantWidth As String)
AddAttr("mini-variant-width", varMiniVariantWidth)
mMiniVariantWidth = varMiniVariantWidth
End Sub

public Sub getMiniVariantWidth() As String
Return mMiniVariantWidth
End Sub
