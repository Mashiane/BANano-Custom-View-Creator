...
#DesignerProperty: Key: FillDot, DisplayName: FillDot, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideDot, DisplayName: HideDot, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mFillDot As Boolean = False
Private mHideDot As Boolean = False
...
mFillDot = Props.Get("FillDot")
mHideDot = Props.Get("HideDot")
...
AddAttr("dark", mDark)
AddAttr("fill-dot", mFillDot)
AddAttr("hide-dot", mHideDot)
AddAttr("icon", mIcon)
...
public Sub setFillDot(varFillDot As Boolean)
AddAttr("fill-dot", varFillDot)
mFillDot = varFillDot
End Sub

public Sub getFillDot() As Boolean
Return mFillDot
End Sub

public Sub setHideDot(varHideDot As Boolean)
AddAttr("hide-dot", varHideDot)
mHideDot = varHideDot
End Sub

public Sub getHideDot() As Boolean
Return mHideDot
End Sub
