...
#DesignerProperty: Key: Complete, DisplayName: Complete, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: CompleteIcon, DisplayName: CompleteIcon, FieldType: String, DefaultValue: $complete , Description: 
#DesignerProperty: Key: EditIcon, DisplayName: EditIcon, FieldType: String, DefaultValue: $edit , Description: 
#DesignerProperty: Key: Editable, DisplayName: Editable, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ErrorIcon, DisplayName: ErrorIcon, FieldType: String, DefaultValue: $error , Description: 
...
#DesignerProperty: Key: Step, DisplayName: Step, FieldType: String, DefaultValue:  , Description: 
...
Private mComplete As Boolean = False
Private mCompleteIcon As String = "$complete"
Private mEditIcon As String = "$edit"
Private mEditable As Boolean = False
Private mErrorIcon As String = "$error"
...
mComplete = Props.Get("Complete")
mCompleteIcon = Props.Get("CompleteIcon")
mEditIcon = Props.Get("EditIcon")
mEditable = Props.Get("Editable")
mErrorIcon = Props.Get("ErrorIcon")
mKey = Props.Get("Key")
...
AddAttr("complete", mComplete)
AddAttr("complete-icon", mCompleteIcon)
AddAttr("edit-icon", mEditIcon)
AddAttr("editable", mEditable)
AddAttr("error-icon", mErrorIcon)
AddAttr("key", mKey)
...
public Sub setCompleteIcon(varCompleteIcon As String)
AddAttr("complete-icon", varCompleteIcon)
mCompleteIcon = varCompleteIcon
End Sub

public Sub getCompleteIcon() As String
Return mCompleteIcon
End Sub

public Sub setEditIcon(varEditIcon As String)
AddAttr("edit-icon", varEditIcon)
mEditIcon = varEditIcon
End Sub

public Sub getEditIcon() As String
Return mEditIcon
End Sub
...
public Sub setErrorIcon(varErrorIcon As String)
AddAttr("error-icon", varErrorIcon)
mErrorIcon = varErrorIcon
End Sub

public Sub getErrorIcon() As String
Return mErrorIcon
End Sub
