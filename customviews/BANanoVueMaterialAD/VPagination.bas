...
#DesignerProperty: Key: Circle, DisplayName: Circle, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: CurrentPageAriaLabel, DisplayName: CurrentPageAriaLabel, FieldType: String, DefaultValue: $vuetify.pagination.ariaLabel.currentPage , Description: 
...
#DesignerProperty: Key: Length, DisplayName: Length, FieldType: String, DefaultValue: 0 , Description: 
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: NextAriaLabel, DisplayName: NextAriaLabel, FieldType: String, DefaultValue: $vuetify.pagination.ariaLabel.next , Description: 
#DesignerProperty: Key: NextIcon, DisplayName: NextIcon, FieldType: String, DefaultValue: $next , Description: 
#DesignerProperty: Key: PageAriaLabel, DisplayName: PageAriaLabel, FieldType: String, DefaultValue: $vuetify.pagination.ariaLabel.page , Description: 
...
#DesignerProperty: Key: PreviousAriaLabel, DisplayName: PreviousAriaLabel, FieldType: String, DefaultValue: $vuetify.pagination.ariaLabel.previous , Description: 
#DesignerProperty: Key: Ref, DisplayName: Ref, FieldType: String, DefaultValue:  , Description: ref
#DesignerProperty: Key: TotalVisible, DisplayName: TotalVisible, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: String, DefaultValue: 0 , Description: 
#DesignerProperty: Key: WrapperAriaLabel, DisplayName: WrapperAriaLabel, FieldType: String, DefaultValue: $vuetify.pagination.ariaLabel.wrapper , Description: 
...
Private mCurrentPageAriaLabel As String = "$vuetify.pagination.ariaLabel.currentPage"
Private mDark As Boolean = False
Private mDisabled As Boolean = False
Private mKey As String = ""
Private mLength As String = "0"
Private mLight As Boolean = False
Private mNextAriaLabel As String = "$vuetify.pagination.ariaLabel.next"
Private mNextIcon As String = "$next"
Private mPageAriaLabel As String = "$vuetify.pagination.ariaLabel.page"
Private mParentId As String = ""
Private mPrevIcon As String = "$prev"
Private mPreviousAriaLabel As String = "$vuetify.pagination.ariaLabel.previous"
Private mRef As String = ""
Private mTotalVisible As String = ""
...
Private mValue As String = "0"
Private mWrapperAriaLabel As String = "$vuetify.pagination.ariaLabel.wrapper"
...
mCircle = Props.Get("Circle")
mColor = Props.Get("Color")
mCurrentPageAriaLabel = Props.Get("CurrentPageAriaLabel")
mDark = Props.Get("Dark")
mDisabled = Props.Get("Disabled")
mKey = Props.Get("Key")
mLength = Props.Get("Length")
mLight = Props.Get("Light")
mNextAriaLabel = Props.Get("NextAriaLabel")
mNextIcon = Props.Get("NextIcon")
mPageAriaLabel = Props.Get("PageAriaLabel")
mParentId = Props.Get("ParentId")
mPrevIcon = Props.Get("PrevIcon")
mPreviousAriaLabel = Props.Get("PreviousAriaLabel")
mRef = Props.Get("Ref")
mTotalVisible = Props.Get("TotalVisible")
...
mWrapperAriaLabel = Props.Get("WrapperAriaLabel")
...
AddAttr("circle", mCircle)
AddAttr("color", mColor)
AddAttr("current-page-aria-label", mCurrentPageAriaLabel)
AddAttr("dark", mDark)
AddAttr("disabled", mDisabled)
AddAttr("key", mKey)
AddAttr("length", mLength)
AddAttr("light", mLight)
AddAttr("next-aria-label", mNextAriaLabel)
AddAttr("next-icon", mNextIcon)
AddAttr("page-aria-label", mPageAriaLabel)
AddAttr("parent-id", mParentId)
AddAttr("prev-icon", mPrevIcon)
AddAttr("previous-aria-label", mPreviousAriaLabel)
AddAttr("ref", mRef)
AddAttr("total-visible", mTotalVisible)
...
AddAttr("wrapper-aria-label", mWrapperAriaLabel)
...
public Sub setCurrentPageAriaLabel(varCurrentPageAriaLabel As String)
AddAttr("current-page-aria-label", varCurrentPageAriaLabel)
mCurrentPageAriaLabel = varCurrentPageAriaLabel
End Sub

public Sub getCurrentPageAriaLabel() As String
Return mCurrentPageAriaLabel
End Sub
...
public Sub setNextAriaLabel(varNextAriaLabel As String)
AddAttr("next-aria-label", varNextAriaLabel)
mNextAriaLabel = varNextAriaLabel
End Sub

public Sub getNextAriaLabel() As String
Return mNextAriaLabel
End Sub
...
public Sub setPageAriaLabel(varPageAriaLabel As String)
AddAttr("page-aria-label", varPageAriaLabel)
mPageAriaLabel = varPageAriaLabel
End Sub

public Sub getPageAriaLabel() As String
Return mPageAriaLabel
End Sub
...
public Sub setPreviousAriaLabel(varPreviousAriaLabel As String)
AddAttr("previous-aria-label", varPreviousAriaLabel)
mPreviousAriaLabel = varPreviousAriaLabel
End Sub

public Sub getPreviousAriaLabel() As String
Return mPreviousAriaLabel
End Sub
...
public Sub setTotalVisible(varTotalVisible As String)
AddAttr("total-visible", varTotalVisible)
mTotalVisible = varTotalVisible
End Sub

public Sub getTotalVisible() As String
...
public Sub setWrapperAriaLabel(varWrapperAriaLabel As String)
AddAttr("wrapper-aria-label", varWrapperAriaLabel)
mWrapperAriaLabel = varWrapperAriaLabel
End Sub

public Sub getWrapperAriaLabel() As String
Return mWrapperAriaLabel
End Sub
