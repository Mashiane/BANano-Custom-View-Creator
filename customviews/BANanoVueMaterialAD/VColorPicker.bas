...
#DesignerProperty: Key: CanvasHeight, DisplayName: CanvasHeight, FieldType: String, DefaultValue: 150 , Description: 
...
#DesignerProperty: Key: DotSize, DisplayName: DotSize, FieldType: String, DefaultValue: 10 , Description: 
...
#DesignerProperty: Key: HideCanvas, DisplayName: HideCanvas, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideInputs, DisplayName: HideInputs, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: HideModeSwitch, DisplayName: HideModeSwitch, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Mode, DisplayName: Mode, FieldType: String, DefaultValue: rgba , Description: 
...
#DesignerProperty: Key: ShowSwatches, DisplayName: ShowSwatches, FieldType: Boolean, DefaultValue: False , Description: 

#DesignerProperty: Key: SwatchesMaxHeight, DisplayName: SwatchesMaxHeight, FieldType: String, DefaultValue: 150 , Description: 
...
Private mCanvasHeight As String = "150"
Private mDark As Boolean = False
Private mDisabled As Boolean = False
Private mDotSize As String = "10"
Private mElevation As String = ""
Private mFlat As Boolean = False
Private mHideCanvas As Boolean = False
Private mHideInputs As Boolean = False
Private mHideModeSwitch As Boolean = False
Private mKey As String = ""
Private mLight As Boolean = False
Private mMode As String = "rgba"
Private mParentId As String = ""
Private mRef As String = ""
Private mShowSwatches As Boolean = False
Private mSwatches As List
Private mSwatchesMaxHeight As String = "150"
...
mCanvasHeight = Props.Get("CanvasHeight")
mDark = Props.Get("Dark")
mDisabled = Props.Get("Disabled")
mDotSize = Props.Get("DotSize")
mElevation = Props.Get("Elevation")
mFlat = Props.Get("Flat")
mHideCanvas = Props.Get("HideCanvas")
mHideInputs = Props.Get("HideInputs")
mHideModeSwitch = Props.Get("HideModeSwitch")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mMode = Props.Get("Mode")
mParentId = Props.Get("ParentId")
mRef = Props.Get("Ref")
mShowSwatches = Props.Get("ShowSwatches")
mSwatchesMaxHeight = Props.Get("SwatchesMaxHeight")
...
AddAttr("canvas-height", mCanvasHeight)
AddAttr("dark", mDark)
AddAttr("disabled", mDisabled)
AddAttr("dot-size", mDotSize)
AddAttr("elevation", mElevation)
AddAttr("flat", mFlat)
AddAttr("hide-canvas", mHideCanvas)
AddAttr("hide-inputs", mHideInputs)
AddAttr("hide-mode-switch", mHideModeSwitch)
AddAttr("key", mKey)
AddAttr("light", mLight)
AddAttr("mode", mMode)
AddAttr("parent-id", mParentId)
AddAttr("ref", mRef)
AddAttr("show-swatches", mShowSwatches)
AddAttr("swatches", mSwatches)
AddAttr("swatches-max-height", mSwatchesMaxHeight)
...
public Sub setCanvasHeight(varCanvasHeight As String)
AddAttr("canvas-height", varCanvasHeight)
mCanvasHeight = varCanvasHeight
End Sub

public Sub getCanvasHeight() As String
...
public Sub setDotSize(varDotSize As String)
AddAttr("dot-size", varDotSize)
mDotSize = varDotSize
End Sub

public Sub getDotSize() As String
Return mDotSize
End Sub
...
public Sub setHideCanvas(varHideCanvas As Boolean)
AddAttr("hide-canvas", varHideCanvas)
mHideCanvas = varHideCanvas
End Sub

public Sub getHideCanvas() As Boolean
Return mHideCanvas
End Sub

public Sub setHideInputs(varHideInputs As Boolean)
AddAttr("hide-inputs", varHideInputs)
mHideInputs = varHideInputs
End Sub

public Sub getHideInputs() As Boolean
Return mHideInputs
End Sub

public Sub setHideModeSwitch(varHideModeSwitch As Boolean)
AddAttr("hide-mode-switch", varHideModeSwitch)
mHideModeSwitch = varHideModeSwitch
End Sub

public Sub getHideModeSwitch() As Boolean
Return mHideModeSwitch
End Sub
...
public Sub setShowSwatches(varShowSwatches As Boolean)
AddAttr("show-swatches", varShowSwatches)
mShowSwatches = varShowSwatches
End Sub

public Sub getShowSwatches() As Boolean
Return mShowSwatches
End Sub

public Sub setSwatches(varSwatches As List)
AddAttr("swatches", varSwatches)
mSwatches = varSwatches
End Sub

public Sub getSwatches() As List
Return mSwatches
End Sub

public Sub setSwatchesMaxHeight(varSwatchesMaxHeight As String)
AddAttr("swatches-max-height", varSwatchesMaxHeight)
mSwatchesMaxHeight = varSwatchesMaxHeight
End Sub

public Sub getSwatchesMaxHeight() As String
Return mSwatchesMaxHeight
End Sub
