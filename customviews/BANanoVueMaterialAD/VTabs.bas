...
#DesignerProperty: Key: AlignWithTitle, DisplayName: AlignWithTitle, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: BackgroundColor, DisplayName: BackgroundColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: CenterActive, DisplayName: CenterActive, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Centered, DisplayName: Centered, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: FixedTabs, DisplayName: FixedTabs, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: HideSlider, DisplayName: HideSlider, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: IconsAndText, DisplayName: IconsAndText, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Optional, DisplayName: Optional, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: ShowArrows, DisplayName: ShowArrows, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: SliderColor, DisplayName: SliderColor, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: SliderSize, DisplayName: SliderSize, FieldType: String, DefaultValue: 2 , Description: 
...
Private mAlignWithTitle As Boolean = False
Private mBackgroundColor As String = ""
Private mCenterActive As Boolean = False
Private mCentered As Boolean = False
Private mColor As String = ""
Private mDark As Boolean = False
Private mFixedTabs As Boolean = False
Private mGrow As Boolean = False
Private mHeight As String = ""
Private mHideSlider As Boolean = False
Private mIconsAndText As Boolean = False
Private mKey As String = ""
Private mLight As Boolean = False
Private mMobileBreakpoint As String = ""
Private mNextIcon As String = "$next"
Private mOptional As Boolean = False
Private mParentId As String = ""
Private mPrevIcon As String = "$prev"
Private mRef As String = ""
Private mRight As Boolean = False
Private mShowArrows As String = ""
Private mSliderColor As String = ""
Private mSliderSize As String = "2"
...
mAlignWithTitle = Props.Get("AlignWithTitle")
mBackgroundColor = Props.Get("BackgroundColor")
mCenterActive = Props.Get("CenterActive")
mCentered = Props.Get("Centered")
mColor = Props.Get("Color")
mDark = Props.Get("Dark")
mFixedTabs = Props.Get("FixedTabs")
mGrow = Props.Get("Grow")
mHeight = Props.Get("Height")
mHideSlider = Props.Get("HideSlider")
mIconsAndText = Props.Get("IconsAndText")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mMobileBreakpoint = Props.Get("MobileBreakpoint")
mNextIcon = Props.Get("NextIcon")
mOptional = Props.Get("Optional")
mParentId = Props.Get("ParentId")
mPrevIcon = Props.Get("PrevIcon")
mRef = Props.Get("Ref")
mRight = Props.Get("Right")
mShowArrows = Props.Get("ShowArrows")
mSliderColor = Props.Get("SliderColor")
mSliderSize = Props.Get("SliderSize")
...
AddAttr("align-with-title", mAlignWithTitle)
AddAttr("background-color", mBackgroundColor)
AddAttr("center-active", mCenterActive)
AddAttr("centered", mCentered)
AddAttr("color", mColor)
AddAttr("dark", mDark)
AddAttr("fixed-tabs", mFixedTabs)
AddAttr("grow", mGrow)
AddAttr("height", mHeight)
AddAttr("hide-slider", mHideSlider)
AddAttr("icons-and-text", mIconsAndText)
AddAttr("key", mKey)
AddAttr("light", mLight)
AddAttr("mobile-breakpoint", mMobileBreakpoint)
AddAttr("next-icon", mNextIcon)
AddAttr("optional", mOptional)
AddAttr("parent-id", mParentId)
AddAttr("prev-icon", mPrevIcon)
AddAttr("ref", mRef)
AddAttr("right", mRight)
AddAttr("show-arrows", mShowArrows)
AddAttr("slider-color", mSliderColor)
AddAttr("slider-size", mSliderSize)
...
public Sub setAlignWithTitle(varAlignWithTitle As Boolean)
AddAttr("align-with-title", varAlignWithTitle)
mAlignWithTitle = varAlignWithTitle
End Sub

public Sub getAlignWithTitle() As Boolean
Return mAlignWithTitle
End Sub
...
public Sub setCenterActive(varCenterActive As Boolean)
AddAttr("center-active", varCenterActive)
mCenterActive = varCenterActive
End Sub

public Sub getCenterActive() As Boolean
Return mCenterActive
End Sub

public Sub setCentered(varCentered As Boolean)
AddAttr("centered", varCentered)
mCentered = varCentered
End Sub
...
public Sub setFixedTabs(varFixedTabs As Boolean)
AddAttr("fixed-tabs", varFixedTabs)
mFixedTabs = varFixedTabs
End Sub

public Sub getFixedTabs() As Boolean
Return mFixedTabs
End Sub
...
public Sub setHideSlider(varHideSlider As Boolean)
AddAttr("hide-slider", varHideSlider)
mHideSlider = varHideSlider
End Sub

public Sub getHideSlider() As Boolean
Return mHideSlider
End Sub

public Sub setIconsAndText(varIconsAndText As Boolean)
AddAttr("icons-and-text", varIconsAndText)
mIconsAndText = varIconsAndText
End Sub

public Sub getIconsAndText() As Boolean
Return mIconsAndText
End Sub
...
public Sub setShowArrows(varShowArrows As String)
AddAttr("show-arrows", varShowArrows)
mShowArrows = varShowArrows
End Sub

public Sub getShowArrows() As String
Return mShowArrows
End Sub

public Sub setSliderColor(varSliderColor As String)
AddAttr("slider-color", varSliderColor)
mSliderColor = varSliderColor
End Sub

public Sub getSliderColor() As String
Return mSliderColor
End Sub

public Sub setSliderSize(varSliderSize As String)
AddAttr("slider-size", varSliderSize)
mSliderSize = varSliderSize
End Sub

public Sub getSliderSize() As String
Return mSliderSize
End Sub
