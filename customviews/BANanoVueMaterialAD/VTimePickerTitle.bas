...
#DesignerProperty: Key: Ampm, DisplayName: Ampm, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: AmpmReadonly, DisplayName: AmpmReadonly, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Hour, DisplayName: Hour, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Minute, DisplayName: Minute, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ParentId, DisplayName: ParentId, FieldType: String, DefaultValue:  , Description: parent-id
#DesignerProperty: Key: Period, DisplayName: Period, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: Second, DisplayName: Second, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Selecting, DisplayName: Selecting, FieldType: String, DefaultValue:  , Description: 
...
Private mAmpm As Boolean = False
Private mAmpmReadonly As Boolean = False
Private mColor As String = ""
Private mDisabled As Boolean = False
Private mHour As String = ""
...
mAmpm = Props.Get("Ampm")
mAmpmReadonly = Props.Get("AmpmReadonly")
mColor = Props.Get("Color")
mDisabled = Props.Get("Disabled")
mHour = Props.Get("Hour")
mKey = Props.Get("Key")
mMinute = Props.Get("Minute")
mParentId = Props.Get("ParentId")
mPeriod = Props.Get("Period")
mReadonly = Props.Get("Readonly")
mRef = Props.Get("Ref")
mSecond = Props.Get("Second")
mSelecting = Props.Get("Selecting")
...
AddAttr("ampm", mAmpm)
AddAttr("ampm-readonly", mAmpmReadonly)
AddAttr("color", mColor)
AddAttr("disabled", mDisabled)
AddAttr("hour", mHour)
AddAttr("key", mKey)
AddAttr("minute", mMinute)
AddAttr("parent-id", mParentId)
AddAttr("period", mPeriod)
AddAttr("readonly", mReadonly)
AddAttr("ref", mRef)
AddAttr("second", mSecond)
AddAttr("selecting", mSelecting)
...
public Sub setAmpm(varAmpm As Boolean)
AddAttr("ampm", varAmpm)
mAmpm = varAmpm
End Sub

public Sub getAmpm() As Boolean
Return mAmpm
End Sub

public Sub setAmpmReadonly(varAmpmReadonly As Boolean)
AddAttr("ampm-readonly", varAmpmReadonly)
mAmpmReadonly = varAmpmReadonly
End Sub

public Sub getAmpmReadonly() As Boolean
Return mAmpmReadonly
End Sub
...
public Sub setHour(varHour As String)
AddAttr("hour", varHour)
mHour = varHour
End Sub

public Sub getHour() As String
Return mHour
End Sub
...
public Sub setMinute(varMinute As String)
AddAttr("minute", varMinute)
mMinute = varMinute
End Sub

public Sub getMinute() As String
Return mMinute
End Sub
...
public Sub setPeriod(varPeriod As String)
AddAttr("period", varPeriod)
mPeriod = varPeriod
End Sub

public Sub getPeriod() As String
Return mPeriod
End Sub
...
public Sub setSecond(varSecond As String)
AddAttr("second", varSecond)
mSecond = varSecond
End Sub

public Sub getSecond() As String
Return mSecond
End Sub

public Sub setSelecting(varSelecting As String)
AddAttr("selecting", varSelecting)
mSelecting = varSelecting
End Sub

public Sub getSelecting() As String
Return mSelecting
End Sub
