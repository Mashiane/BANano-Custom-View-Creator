...
#DesignerProperty: Key: BackgroundColor, DisplayName: BackgroundColor, FieldType: String, DefaultValue: accent , Description: 
...
#DesignerProperty: Key: EmptyIcon, DisplayName: EmptyIcon, FieldType: String, DefaultValue: $ratingEmpty , Description: 
#DesignerProperty: Key: FullIcon, DisplayName: FullIcon, FieldType: String, DefaultValue: $ratingFull , Description: 
#DesignerProperty: Key: HalfIcon, DisplayName: HalfIcon, FieldType: String, DefaultValue: $ratingHalf , Description: 
#DesignerProperty: Key: HalfIncrements, DisplayName: HalfIncrements, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Length, DisplayName: Length, FieldType: String, DefaultValue: 5 , Description: 
...
Private mBackgroundColor As String = "accent"
...
Private mEmptyIcon As String = "$ratingEmpty"
Private mFullIcon As String = "$ratingFull"
Private mHalfIcon As String = "$ratingHalf"
Private mHalfIncrements As Boolean = False
Private mHover As Boolean = False
Private mKey As String = ""
Private mLarge As Boolean = False
Private mLength As String = "5"
...
mEmptyIcon = Props.Get("EmptyIcon")
mFullIcon = Props.Get("FullIcon")
mHalfIcon = Props.Get("HalfIcon")
mHalfIncrements = Props.Get("HalfIncrements")
...
AddAttr("empty-icon", mEmptyIcon)
AddAttr("full-icon", mFullIcon)
AddAttr("half-icon", mHalfIcon)
AddAttr("half-increments", mHalfIncrements)
...
public Sub setEmptyIcon(varEmptyIcon As String)
AddAttr("empty-icon", varEmptyIcon)
mEmptyIcon = varEmptyIcon
End Sub

public Sub getEmptyIcon() As String
Return mEmptyIcon
End Sub

public Sub setFullIcon(varFullIcon As String)
AddAttr("full-icon", varFullIcon)
mFullIcon = varFullIcon
End Sub

public Sub getFullIcon() As String
Return mFullIcon
End Sub

public Sub setHalfIcon(varHalfIcon As String)
AddAttr("half-icon", varHalfIcon)
mHalfIcon = varHalfIcon
End Sub

public Sub getHalfIcon() As String
Return mHalfIcon
End Sub

public Sub setHalfIncrements(varHalfIncrements As Boolean)
AddAttr("half-increments", varHalfIncrements)
mHalfIncrements = varHalfIncrements
End Sub

public Sub getHalfIncrements() As Boolean
Return mHalfIncrements
End Sub
