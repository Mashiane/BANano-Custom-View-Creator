...
#DesignerProperty: Key: Ripple, DisplayName: Ripple, FieldType: Boolean, DefaultValue: True , Description: 
...
#DesignerProperty: Key: Value, DisplayName: Value, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mRipple As Boolean = True
