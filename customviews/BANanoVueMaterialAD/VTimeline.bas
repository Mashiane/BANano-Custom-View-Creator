...
#DesignerProperty: Key: AlignTop, DisplayName: AlignTop, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mAlignTop As Boolean = False
...
public Sub setAlignTop(varAlignTop As Boolean)
AddAttr("align-top", varAlignTop)
mAlignTop = varAlignTop
End Sub

public Sub getAlignTop() As Boolean
Return mAlignTop
End Sub
