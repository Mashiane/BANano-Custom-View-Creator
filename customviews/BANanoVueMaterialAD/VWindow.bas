...
#DesignerProperty: Key: Continuous, DisplayName: Continuous, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: ShowArrows, DisplayName: ShowArrows, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mContinuous As Boolean = False
...
Private mShowArrows As Boolean = False
