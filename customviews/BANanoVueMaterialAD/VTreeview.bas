...
#DesignerProperty: Key: Activatable, DisplayName: Activatable, FieldType: Boolean, DefaultValue: False , Description: 

#DesignerProperty: Key: ActiveClass, DisplayName: ActiveClass, FieldType: String, DefaultValue: v-treeview-node--active , Description: 
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: primary , Description: 
...
#DesignerProperty: Key: ExpandIcon, DisplayName: ExpandIcon, FieldType: String, DefaultValue: $subgroup , Description: 
#DesignerProperty: Key: Filter, DisplayName: Filter, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: Hoverable, DisplayName: Hoverable, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: IndeterminateIcon, DisplayName: IndeterminateIcon, FieldType: String, DefaultValue: $checkboxIndeterminate , Description: 
#DesignerProperty: Key: ItemChildren, DisplayName: ItemChildren, FieldType: String, DefaultValue: children , Description: 
...
#DesignerProperty: Key: ItemText, DisplayName: ItemText, FieldType: String, DefaultValue: name , Description: 

#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: LoadChildren, DisplayName: LoadChildren, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: LoadingIcon, DisplayName: LoadingIcon, FieldType: String, DefaultValue: $loading , Description: 
#DesignerProperty: Key: MultipleActive, DisplayName: MultipleActive, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: OffIcon, DisplayName: OffIcon, FieldType: String, DefaultValue: $checkboxOff , Description: 
#DesignerProperty: Key: OnIcon, DisplayName: OnIcon, FieldType: String, DefaultValue: $checkboxOn , Description: 

#DesignerProperty: Key: OpenAll, DisplayName: OpenAll, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Selectable, DisplayName: Selectable, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: SelectedColor, DisplayName: SelectedColor, FieldType: String, DefaultValue: accent , Description: 
#DesignerProperty: Key: SelectionType, DisplayName: SelectionType, FieldType: String, DefaultValue: leaf , Description: 
#DesignerProperty: Key: Shaped, DisplayName: Shaped, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mActivatable As Boolean = False
Private mActive As List
Private mActiveClass As String = "v-treeview-node--active"
Private mColor As String = "primary"
Private mDark As Boolean = False
Private mDense As Boolean = False
Private mExpandIcon As String = "$subgroup"
Private mFilter As String = ""
Private mHoverable As Boolean = False
Private mIndeterminateIcon As String = "$checkboxIndeterminate"
Private mItemChildren As String = "children"
Private mItemDisabled As String = "disabled"
Private mItemKey As String = "id"
Private mItemText As String = "name"
Private mItems As List
Private mKey As String = ""
Private mLight As Boolean = False
Private mLoadChildren As String = ""
Private mLoadingIcon As String = "$loading"
Private mMultipleActive As Boolean = False
Private mOffIcon As String = "$checkboxOff"
Private mOnIcon As String = "$checkboxOn"
Private mOpen As List
Private mOpenAll As Boolean = False
...
Private mSelectable As Boolean = False
Private mSelectedColor As String = "accent"
Private mSelectionType As String = "leaf"
Private mShaped As Boolean = False
Private mTransition As Boolean = False
...
mActivatable = Props.Get("Activatable")
mActiveClass = Props.Get("ActiveClass")
mColor = Props.Get("Color")
mDark = Props.Get("Dark")
mDense = Props.Get("Dense")
mExpandIcon = Props.Get("ExpandIcon")
mFilter = Props.Get("Filter")
mHoverable = Props.Get("Hoverable")
mIndeterminateIcon = Props.Get("IndeterminateIcon")
mItemChildren = Props.Get("ItemChildren")
mItemDisabled = Props.Get("ItemDisabled")
mItemKey = Props.Get("ItemKey")
mItemText = Props.Get("ItemText")
mKey = Props.Get("Key")
mLight = Props.Get("Light")
mLoadChildren = Props.Get("LoadChildren")
mLoadingIcon = Props.Get("LoadingIcon")
mMultipleActive = Props.Get("MultipleActive")
mOffIcon = Props.Get("OffIcon")
mOnIcon = Props.Get("OnIcon")
mOpenAll = Props.Get("OpenAll")
...
mSelectable = Props.Get("Selectable")
mSelectedColor = Props.Get("SelectedColor")
mSelectionType = Props.Get("SelectionType")
...
AddAttr("activatable", mActivatable)
AddAttr("active", mActive)
AddAttr("active-class", mActiveClass)
AddAttr("color", mColor)
AddAttr("dark", mDark)
AddAttr("dense", mDense)
AddAttr("expand-icon", mExpandIcon)
AddAttr("filter", mFilter)
AddAttr("hoverable", mHoverable)
AddAttr("indeterminate-icon", mIndeterminateIcon)
AddAttr("item-children", mItemChildren)
...
AddAttr("load-children", mLoadChildren)
AddAttr("loading-icon", mLoadingIcon)
AddAttr("multiple-active", mMultipleActive)
AddAttr("off-icon", mOffIcon)
AddAttr("on-icon", mOnIcon)
AddAttr("open", mOpen)
AddAttr("open-all", mOpenAll)
...
AddAttr("selectable", mSelectable)
AddAttr("selected-color", mSelectedColor)
AddAttr("selection-type", mSelectionType)
...
public Sub setExpandIcon(varExpandIcon As String)
AddAttr("expand-icon", varExpandIcon)
mExpandIcon = varExpandIcon
End Sub

public Sub getExpandIcon() As String
Return mExpandIcon
End Sub
...
public Sub setIndeterminateIcon(varIndeterminateIcon As String)
AddAttr("indeterminate-icon", varIndeterminateIcon)
mIndeterminateIcon = varIndeterminateIcon
End Sub

public Sub getIndeterminateIcon() As String
Return mIndeterminateIcon
End Sub

public Sub setItemChildren(varItemChildren As String)
AddAttr("item-children", varItemChildren)
mItemChildren = varItemChildren
End Sub

public Sub getItemChildren() As String
...
public Sub setLoadChildren(varLoadChildren As String)
AddAttr("load-children", varLoadChildren)
mLoadChildren = varLoadChildren
End Sub

public Sub getLoadChildren() As String
Return mLoadChildren
End Sub

public Sub setLoadingIcon(varLoadingIcon As String)
AddAttr("loading-icon", varLoadingIcon)
mLoadingIcon = varLoadingIcon
End Sub

public Sub getLoadingIcon() As String
Return mLoadingIcon
End Sub

public Sub setMultipleActive(varMultipleActive As Boolean)
AddAttr("multiple-active", varMultipleActive)
mMultipleActive = varMultipleActive
End Sub

public Sub getMultipleActive() As Boolean
Return mMultipleActive
End Sub

public Sub setOffIcon(varOffIcon As String)
AddAttr("off-icon", varOffIcon)
mOffIcon = varOffIcon
End Sub

public Sub getOffIcon() As String
Return mOffIcon
End Sub

public Sub setOnIcon(varOnIcon As String)
AddAttr("on-icon", varOnIcon)
mOnIcon = varOnIcon
End Sub

public Sub getOnIcon() As String
Return mOnIcon
End Sub

public Sub setOpen(varOpen As List)
AddAttr("open", varOpen)
mOpen = varOpen
End Sub

public Sub getOpen() As List
Return mOpen
End Sub

public Sub setOpenAll(varOpenAll As Boolean)
AddAttr("open-all", varOpenAll)
mOpenAll = varOpenAll
End Sub

public Sub getOpenAll() As Boolean
Return mOpenAll
End Sub
...
public Sub setSelectedColor(varSelectedColor As String)
AddAttr("selected-color", varSelectedColor)
mSelectedColor = varSelectedColor
End Sub

public Sub getSelectedColor() As String
Return mSelectedColor
End Sub

public Sub setSelectionType(varSelectionType As String)
AddAttr("selection-type", varSelectionType)
mSelectionType = varSelectionType
End Sub

public Sub getSelectionType() As String
...
Dim cb As BANanoObject = BANano.CallBack(mCallBack, sName, Array(argument As list))
