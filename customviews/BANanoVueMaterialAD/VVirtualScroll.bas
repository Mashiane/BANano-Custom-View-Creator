...
#DesignerProperty: Key: Bench, DisplayName: Bench, FieldType: String, DefaultValue: 0 , Description: 
#DesignerProperty: Key: Height, DisplayName: Height, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: ItemHeight, DisplayName: ItemHeight, FieldType: String, DefaultValue:  , Description: 
...
Private mBench As String = "0"
Private mHeight As String = ""
Private mItemHeight As String = ""
...
mBench = Props.Get("Bench")
mHeight = Props.Get("Height")
mItemHeight = Props.Get("ItemHeight")
mKey = Props.Get("Key")
...
AddAttr("bench", mBench)
AddAttr("height", mHeight)
AddAttr("item-height", mItemHeight)
...
public Sub setItemHeight(varItemHeight As String)
AddAttr("item-height", varItemHeight)
mItemHeight = varItemHeight
End Sub

public Sub getItemHeight() As String
Return mItemHeight
End Sub
