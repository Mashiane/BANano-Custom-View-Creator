...
#DesignerProperty: Key: Direction, DisplayName: Direction, FieldType: String, DefaultValue: top , Description: 
...
#DesignerProperty: Key: Transition, DisplayName: Transition, FieldType: String, DefaultValue: scale-transition , Description: 
...
Private mDirection As String = "top"
...
Private mTransition As String = "scale-transition"
...
mDirection = Props.Get("Direction")
