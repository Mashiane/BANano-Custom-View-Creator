...
#DesignerProperty: Key: AutoGrow, DisplayName: AutoGrow, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: NoResize, DisplayName: NoResize, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: RowHeight, DisplayName: RowHeight, FieldType: String, DefaultValue: 24 , Description: 
#DesignerProperty: Key: Rows, DisplayName: Rows, FieldType: String, DefaultValue: 5 , Description: 
...
Private mAutoGrow As Boolean = False
...
Private mNoResize As Boolean = False
...
Private mRowHeight As String = "24"
Private mRows As String = "5"
...
mRowHeight = Props.Get("RowHeight")
mRows = Props.Get("Rows")
...
public Sub setAutoGrow(varAutoGrow As Boolean)
AddAttr("auto-grow", varAutoGrow)
mAutoGrow = varAutoGrow
End Sub

public Sub getAutoGrow() As Boolean
Return mAutoGrow
End Sub
...
public Sub setNoResize(varNoResize As Boolean)
AddAttr("no-resize", varNoResize)
mNoResize = varNoResize
End Sub

public Sub getNoResize() As Boolean
Return mNoResize
End Sub
...
public Sub setRowHeight(varRowHeight As String)
AddAttr("row-height", varRowHeight)
mRowHeight = varRowHeight
End Sub

public Sub getRowHeight() As String
Return mRowHeight
End Sub
