...
#DesignerProperty: Key: DisableIconRotate, DisplayName: DisableIconRotate, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: ExpandIcon, DisplayName: ExpandIcon, FieldType: String, DefaultValue: $expand , Description: 
#DesignerProperty: Key: HideActions, DisplayName: HideActions, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mDisableIconRotate As Boolean = False
Private mExpandIcon As String = "$expand"
Private mHideActions As Boolean = False
...
mDisableIconRotate = Props.Get("DisableIconRotate")
mExpandIcon = Props.Get("ExpandIcon")
mHideActions = Props.Get("HideActions")
mKey = Props.Get("Key")
...
AddAttr("disable-icon-rotate", mDisableIconRotate)
AddAttr("expand-icon", mExpandIcon)
AddAttr("hide-actions", mHideActions)
AddAttr("key", mKey)
...
public Sub setDisableIconRotate(varDisableIconRotate As Boolean)
AddAttr("disable-icon-rotate", varDisableIconRotate)
mDisableIconRotate = varDisableIconRotate
End Sub

public Sub getDisableIconRotate() As Boolean
Return mDisableIconRotate
End Sub
...
public Sub setHideActions(varHideActions As Boolean)
AddAttr("hide-actions", varHideActions)
mHideActions = varHideActions
End Sub

public Sub getHideActions() As Boolean
Return mHideActions
End Sub
