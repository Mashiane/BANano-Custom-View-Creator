...
#DesignerProperty: Key: Color, DisplayName: Color, FieldType: String, DefaultValue: #212121 , Description: 
#DesignerProperty: Key: Dark, DisplayName: Dark, FieldType: Boolean, DefaultValue: True , Description: 
#DesignerProperty: Key: Key, DisplayName: Key, FieldType: String, DefaultValue:  , Description: key
#DesignerProperty: Key: Light, DisplayName: Light, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: Opacity, DisplayName: Opacity, FieldType: String, DefaultValue: 0.46 , Description: 
...
#DesignerProperty: Key: ZIndex, DisplayName: ZIndex, FieldType: String, DefaultValue: 5 , Description: 
...
Private mColor As String = "#212121"
Private mDark As Boolean = True
Private mKey As String = ""
Private mLight As Boolean = False
Private mOpacity As String = "0.46"
