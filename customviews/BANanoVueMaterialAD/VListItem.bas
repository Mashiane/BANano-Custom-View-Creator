...
#DesignerProperty: Key: Inactive, DisplayName: Inactive, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: ThreeLine, DisplayName: ThreeLine, FieldType: Boolean, DefaultValue: False , Description: 
#DesignerProperty: Key: To, DisplayName: To, FieldType: String, DefaultValue:  , Description: 
#DesignerProperty: Key: TwoLine, DisplayName: TwoLine, FieldType: Boolean, DefaultValue: False , Description: 
...
Private mInactive As Boolean = False
...
Private mThreeLine As Boolean = False
Private mTo As String = ""
Private mTwoLine As Boolean = False
...
mThreeLine = Props.Get("ThreeLine")
mTo = Props.Get("To")
mTwoLine = Props.Get("TwoLine")
...
AddAttr("three-line", mThreeLine)
AddAttr("to", mTo)
AddAttr("two-line", mTwoLine)
...
public Sub setThreeLine(varThreeLine As Boolean)
AddAttr("three-line", varThreeLine)
mThreeLine = varThreeLine
End Sub

public Sub getThreeLine() As Boolean
Return mThreeLine
End Sub
...
public Sub setTwoLine(varTwoLine As Boolean)
AddAttr("two-line", varTwoLine)
mTwoLine = varTwoLine
End Sub

public Sub getTwoLine() As Boolean
Return mTwoLine
End Sub
