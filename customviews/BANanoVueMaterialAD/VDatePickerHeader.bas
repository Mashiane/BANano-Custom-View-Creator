...
#DesignerProperty: Key: NextAriaLabel, DisplayName: NextAriaLabel, FieldType: String, DefaultValue:  , Description: 
...
#DesignerProperty: Key: PrevAriaLabel, DisplayName: PrevAriaLabel, FieldType: String, DefaultValue:  , Description: 
...
Private mNextAriaLabel As String = ""
Private mNextIcon As String = "$next"
Private mParentId As String = ""
Private mPrevAriaLabel As String = ""
...
mPrevAriaLabel = Props.Get("PrevAriaLabel")
...
AddAttr("prev-aria-label", mPrevAriaLabel)
...
public Sub setPrevAriaLabel(varPrevAriaLabel As String)
AddAttr("prev-aria-label", varPrevAriaLabel)
mPrevAriaLabel = varPrevAriaLabel
End Sub

public Sub getPrevAriaLabel() As String
Return mPrevAriaLabel
End Sub
