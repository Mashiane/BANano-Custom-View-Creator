...
#DesignerProperty: Key: Boilerplate, DisplayName: Boilerplate, FieldType: Boolean, DefaultValue: False , Description: 
...
#DesignerProperty: Key: Types, DisplayName: Types, FieldType: String, DefaultValue:  , Description: 
...
Private mBoilerplate As Boolean = False
...
mBoilerplate = Props.Get("Boilerplate")
...
AddAttr("boilerplate", mBoilerplate)
AddAttr("dark", mDark)
